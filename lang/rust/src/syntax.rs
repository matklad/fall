...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"ty":14,"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":10}],null]}]},{"Or":[{"And":[[{"Rule":1}],null]},{"And":[[{"Rule":2}],null]}]}]}}],null]}]}},{"ty":15,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":8}],null]}]}},{"Token":11},{"Token":12},{"Token":2},{"Token":3},{"Rule":3}],2]}]}},{"ty":16,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":8}],null]}]}},{"Token":10},{"Token":12},{"Token":4},{"Token":5}],2]}]}},{"ty":17,"body":{"Or":[{"And":[[{"Token":4},{"Layer":[{"Rule":4},{"Rep":{"Rule":6}}]},{"Token":5}],null]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Rep":{"Rule":5}}],null]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Token":4},{"Rule":4},{"Token":5}],1]},{"And":[[{"Not":[5]}],null]}]}},{"ty":18,"body":{"Or":[{"And":[[{"Token":9},{"Rule":7},{"Token":6},{"Rule":8},{"Token":7}],1]}]}},{"ty":19,"body":{"Or":[{"And":[[{"Token":12}],null]}]}},{"ty":20,"body":{"Or":[{"And":[[{"Token":13}],null]}]}}]"##;
