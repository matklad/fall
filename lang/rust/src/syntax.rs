...
pub const LITERAL: NodeType = NodeType(143);
pub const PATH_EXPR: NodeType = NodeType(144);
pub const BLOCK_EXPR: NodeType = NodeType(145);
pub const LET_STMT: NodeType = NodeType(146);
pub const EXPR_STMT: NodeType = NodeType(147);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, LPAREN, RPAREN, LBRACE, RBRACE, LANGLE, RANGLE, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, STAR, IDENT, NUMBER, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, STRUCT_DEF, MOD_DEF, STRUCT_FIELD, TUPLE_FIELD, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE, PATTERN, EXPR, LITERAL, PATH_EXPR, BLOCK_EXPR, LET_STMT, EXPR_STMT,
        ];
        let parser_json = r##"[{"body":{"Pub":[26,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":7}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":8}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"Token":4}],null]},{"And":[[{"Token":10}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":11}],null]},{"And":[[{"Rule":12}],null]}]}},{"body":{"Pub":[27,{"Or":[{"And":[[{"Token":9},{"Or":[{"And":[[{"Rule":16},{"Or":[{"And":[[{"Rule":24}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":21},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":21}},{"Rule":5}],null]}]},{"Token":19}],1]}]}]}},{"body":{"Pub":[28,{"Or":[{"And":[[{"Token":23}],null]},{"And":[[{"Call":[{"Rule":35},[[1,{"Call":[{"Rule":34},[[0,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[29,{"Or":[{"And":[[{"Token":24},{"Opt":{"Rule":24}}],1]}]}]}},{"body":{"Pub":[30,{"Or":[{"And":[[{"Token":4},{"Token":3},{"Token":24},{"Opt":{"Rule":24}},{"Token":19}],2]}]}]}},{"body":{"Pub":[31,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":5},{"Token":24},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":17},{"Rule":25}],null]}]}},{"Rule":30}],2]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":36},[[2,{"Call":[{"Rule":34},[[0,{"Rule":10}]]]}]]]}],null]}]}},{"body":{"Pub":[32,{"Or":[{"And":[[{"Rule":26},{"Token":20},{"Rule":25}],null]}]}]}},{"body":{"Pub":[33,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":8},{"Token":24},{"Or":[{"And":[[{"Call":[{"Rule":35},[[1,{"Call":[{"Rule":34},[[0,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Token":19}],null]},{"And":[[{"Call":[{"Rule":36},[[2,{"Call":[{"Rule":34},[[0,{"Rule":14}]]]}]]]},{"Token":19}],null]}]}],2]}]}]}},{"body":{"Pub":[34,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":10},{"Token":24},{"Or":[{"And":[[{"Token":19}],null]},{"And":[[{"Call":[{"Rule":35},[[1,{"Rule":1}]]]}],null]}]}],2]}]}]}},{"body":{"Pub":[35,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":24},{"Token":20},{"Rule":25}],2]}]}]}},{"body":{"Pub":[36,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Rule":25}],null]}]}]}},{"body":{"Pub":[37,{"Or":[{"And":[[{"Token":7}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":19}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":19}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":19}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[38,{"Or":[{"And":[[{"Opt":{"Token":21}},{"Rule":22}],null]}]}]}}},{"Postfix":{"ty":38,"op":{"Or":[{"And":[[{"Token":21},{"Rule":22}],null]}]}}}]}},{"body":{"Pub":[38,{"Or":[{"And":[[{"Opt":{"Token":21}},{"Rule":22}],null]}]}]}},{"body":{"Pub":[38,{"Or":[{"And":[[{"Rule":19},{"Or":[{"And":[[{"Token":21},{"Rule":22}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":24},{"Opt":{"Rule":23}}],null]}]}},{"body":{"Pub":[39,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":21}],null]}]},{"Call":[{"Rule":37},[[3,{"Call":[{"Rule":34},[[0,{"Rule":25}]]]}]]]}],null]}]}]}},{"body":{"Pub":[40,{"Or":[{"And":[[{"Token":2},{"Token":24}],null]}]}]}},{"body":{"Pub":[41,{"Or":[{"And":[[{"Rule":17}],null]}]}]}},{"body":{"Pub":[42,{"Or":[{"And":[[{"Token":24}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[44,{"Or":[{"And":[[{"Token":25}],null]}]}]}}},{"Atom":{"body":{"Pub":[45,{"Or":[{"And":[[{"Rule":18}],null]}]}]}}},{"Atom":{"body":{"Pub":[46,{"Or":[{"And":[[{"Call":[{"Rule":35},[[1,{"Or":[{"And":[[{"Rep":{"Rule":31}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}}}]}},{"body":{"Pub":[44,{"Or":[{"And":[[{"Token":25}],null]}]}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Rule":18}],null]}]}]}},{"body":{"Pub":[46,{"Or":[{"And":[[{"Call":[{"Rule":35},[[1,{"Or":[{"And":[[{"Rep":{"Rule":31}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":32}],null]},{"And":[[{"Rule":33}],null]}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Token":6},{"Rule":26},{"Token":18},{"Rule":27},{"Token":19}],1]}]}]}},{"body":{"Pub":[48,{"Or":[{"And":[[{"Rule":27},{"Token":19}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":0},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":22}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":38},[[4,{"Token":13}],[5,{"Token":14}],[6,{"Var":1}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":38},[[4,{"Token":11}],[5,{"Token":12}],[6,{"Var":2}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":38},[[4,{"Token":15}],[5,{"Token":16}],[6,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":4},{"Layer":[{"Call":[{"Rule":39},[[7,{"Var":4}],[8,{"Var":5}]]]},{"Var":6}]},{"Var":5}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":7},{"Call":[{"Rule":39},[[7,{"Var":7}],[8,{"Var":8}]]]},{"Var":8}],1]},{"And":[[{"Not":{"Var":8}}],null]}]}}],null]}]}}]"##;
