...
pub const PATTERN: NodeType = NodeType(185);
pub const EXPR: NodeType = NodeType(186);
pub const LITERAL: NodeType = NodeType(187);
pub const STRUCT_LITERAL: NodeType = NodeType(188);
pub const STRUCT_LITERAL_FIELD: NodeType = NodeType(189);
pub const PATH_EXPR: NodeType = NodeType(190);
pub const UNIT_EXPR: NodeType = NodeType(191);
pub const PAREN_EXPR: NodeType = NodeType(192);
pub const TUPLE_EXPR: NodeType = NodeType(193);
pub const LAMBDA_EXPR: NodeType = NodeType(194);
pub const BLOCK_EXPR: NodeType = NodeType(195);
pub const LET_STMT: NodeType = NodeType(196);
pub const EMPTY_STMT: NodeType = NodeType(197);
pub const EXPR_STMT: NodeType = NodeType(198);
pub const IF_EXPR: NodeType = NodeType(199);
pub const WHILE_EXPR: NodeType = NodeType(200);
pub const LOOP_EXPR: NodeType = NodeType(201);
pub const CALL_EXPR: NodeType = NodeType(202);
pub const FIELD_EXPR: NodeType = NodeType(203);
pub const VALUE_ARGUMENT: NodeType = NodeType(204);
pub const REFERENCE_EXPR: NodeType = NodeType(205);
pub const DEREFERENCE_EXPR: NodeType = NodeType(206);
pub const NEGATION_EXPR: NodeType = NodeType(207);
pub const PRODUCT_EXPR: NodeType = NodeType(208);
pub const SUM_EXPR: NodeType = NodeType(209);
pub const BIT_SHIFT: NodeType = NodeType(210);
pub const BIT_AND: NodeType = NodeType(211);
pub const BIT_OR: NodeType = NodeType(212);
pub const ATTRIBUTE: NodeType = NodeType(213);
pub const ATTR_VALUE: NodeType = NodeType(214);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, UNION, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, ENUM, IMPL, SELF, SUPER, TYPE, CONST, FOR, LOOP, WHILE, MOVE, MUT, L_PAREN, R_PAREN, L_CURLY, R_CURLY, L_ANGLE, R_ANGLE, L_BRACK, R_BRACK, SHL, SHR, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, DOT, HASH, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, LIFETIME, IDENT, NUMBER, STRING, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, LAMBDA_VALUE_PARAM, SELF_PARAMETER, STRUCT_DEF, STRUCT_FIELD, TUPLE_FIELD, ENUM_DEF, ENUM_VARIANT, MOD_DEF, IMPL_DEF, TYPE_DEF, CONST_DEF, TYPE_PARAMETERS, TYPE_PARAMETER, LIFETIME_PARAMETER, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, PATH_TYPE, REFERENCE_TYPE, PLACEHOLDER_TYPE, UNIT_TYPE, PAREN_TYPE, TUPLE_TYPE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PATH_EXPR, UNIT_EXPR, PAREN_EXPR, TUPLE_EXPR, LAMBDA_EXPR, BLOCK_EXPR, LET_STMT, EMPTY_STMT, EXPR_STMT, IF_EXPR, WHILE_EXPR, LOOP_EXPR, CALL_EXPR, FIELD_EXPR, VALUE_ARGUMENT, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR, ATTRIBUTE, ATTR_VALUE,
        ];
        let parser_json = r##"[{"body":{"Pub":{"ty_idx":55,"body":{"Or":[{"And":[[{"Rule":1}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":42}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]},{"And":[[{"Token":14}],null]},{"And":[[{"Token":10}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":15}],null]},{"And":[[{"Token":18}],null]},{"And":[[{"Token":19}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":13}],null]},{"And":[[{"Rule":16}],null]},{"And":[[{"Rule":18}],null]},{"And":[[{"Rule":19}],null]},{"And":[[{"Rule":22}],null]},{"And":[[{"Rule":23}],null]}]}},{"body":{"Pub":{"ty_idx":56,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":10},{"Or":[{"And":[[{"Rule":28},{"Or":[{"And":[[{"Rule":36}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":39},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":39}},{"Rule":5}],null]}]},{"Token":37}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":57,"body":{"Or":[{"And":[[{"Token":43}],null]},{"And":[[{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":6}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":58,"body":{"Or":[{"And":[[{"Token":52},{"Opt":{"Rule":36}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":59,"body":{"Or":[{"And":[[{"Rule":79},{"Token":5},{"Token":4},{"Token":52},{"Opt":{"Rule":36}},{"Token":37}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":60,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":6},{"Token":52},{"Opt":{"Rule":24}},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":35},{"Rule":37}],null]}]}},{"Rule":57}],3]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":83},[[4,{"Or":[{"And":[[{"Opt":{"Rule":12}},{"Call":[{"Rule":81},[[2,{"Rule":10}]]]}],null]}]}]]]}],null]}]}},{"body":{"Pub":{"ty_idx":61,"body":{"Or":[{"And":[[{"Rule":44},{"Token":38},{"Rule":37}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":62,"body":{"Or":[{"And":[[{"Rule":44},{"Opt":{"Or":[{"And":[[{"Token":38},{"Rule":37}],null]}]}}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":63,"body":{"Or":[{"And":[[{"Opt":{"Token":48}},{"Token":16},{"Or":[{"And":[[{"Token":40}],null]},{"And":[["Eof"],null]}]}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":64,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Or":[{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]}]},{"Token":52},{"Opt":{"Rule":24}},{"Or":[{"And":[[{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":14}]]]}]]]}],null]},{"And":[[{"Token":37}],null]},{"And":[[{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":15}]]]}]]]},{"Token":37}],null]}]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":65,"body":{"Or":[{"And":[[{"Opt":{"Rule":27}},{"Token":52},{"Token":38},{"Rule":37}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":66,"body":{"Or":[{"And":[[{"Opt":{"Rule":27}},{"Rule":37}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":67,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":14},{"Token":52},{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":17}]]]}]]]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":68,"body":{"Or":[{"And":[[{"Token":52},{"Opt":{"Or":[{"And":[[{"Token":36},{"Rule":45}],null]},{"And":[[{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":15}]]]}]]]}],null]},{"And":[[{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":14}]]]}]]]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":69,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":11},{"Token":52},{"Or":[{"And":[[{"Token":37}],null]},{"And":[[{"Call":[{"Rule":82},[[3,{"Rule":1}]]]}],null]}]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":70,"body":{"Or":[{"And":[[{"Rule":79},{"Token":15},{"Opt":{"Rule":24}},{"Or":[{"And":[[{"Rule":37},{"Opt":{"Or":[{"And":[[{"Token":20},{"Rule":37}],null]}]}}],null]}]},{"Call":[{"Rule":82},[[3,{"Rep":{"WithSkip":[{"Rule":21},{"Rule":20}]}}]]]}],2]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":22}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":18}],null]}]}},{"body":{"Pub":{"ty_idx":71,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":18},{"Token":52},{"Opt":{"Rule":24}},{"Opt":{"Or":[{"And":[[{"Token":36},{"Rule":37}],null]}]}},{"Token":37}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":72,"body":{"Or":[{"And":[[{"Rule":79},{"Opt":{"Rule":27}},{"Token":19},{"Token":52},{"Token":38},{"Rule":37},{"Token":36},{"Rule":45},{"Token":37}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":73,"body":{"Or":[{"And":[[{"Call":[{"Rule":84},[[5,{"Or":[{"And":[[{"Call":[{"Rule":81},[[2,{"Rule":26}]]]},{"Call":[{"Rule":81},[[2,{"Rule":25}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":74,"body":{"Or":[{"And":[[{"Token":52}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":75,"body":{"Or":[{"And":[[{"Token":51}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":76,"body":{"Or":[{"And":[[{"Token":8}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":31}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":31}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":31}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":{"ty_idx":77,"body":{"Or":[{"And":[[{"Opt":{"Token":39}},{"Rule":34}],null]}]},"replaceable":false}}}},{"Postfix":{"ty":77,"op":{"Or":[{"And":[[{"Token":39},{"Rule":34}],null]}]}}}]}},{"body":{"Pub":{"ty_idx":77,"body":{"Or":[{"And":[[{"Opt":{"Token":39}},{"Rule":34}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":77,"body":{"Or":[{"And":[[{"Rule":31},{"Or":[{"And":[[{"Token":39},{"Rule":34}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":52}],null]},{"And":[[{"Token":16}],null]},{"And":[[{"Token":17}],null]}]},{"Opt":{"Rule":35}}],null]}]}},{"body":{"Pub":{"ty_idx":78,"body":{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":39}],null]}]},{"Call":[{"Rule":84},[[5,{"Or":[{"And":[[{"Call":[{"Rule":81},[[2,{"Token":51}]]]},{"Call":[{"Rule":81},[[2,{"Rule":37}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":79,"body":{"Or":[{"And":[[{"Token":3},{"Token":52}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":38}],null]},{"And":[[{"Rule":39}],null]},{"And":[[{"Rule":41}],null]},{"And":[[{"Rule":42}],null]},{"And":[[{"Rule":40}],null]}]}},{"body":{"Pub":{"ty_idx":80,"body":{"Or":[{"And":[[{"Rule":29}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":81,"body":{"Or":[{"And":[[{"Token":48},{"Opt":{"Token":51}},{"Opt":{"Token":24}},{"Rule":37}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":82,"body":{"Or":[{"And":[[{"Token":50}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":83,"body":{"Or":[{"And":[[{"Token":25},{"Token":26}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":84,"body":{"Or":[{"And":[[{"Call":[{"Rule":83},[[4,{"Or":[{"And":[[{"Rule":37},{"Opt":{"Rule":43}}],null]}]}]]]}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":85,"body":{"Or":[{"And":[[{"Token":40},{"Call":[{"Rule":81},[[2,{"Rule":37}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":86,"body":{"Or":[{"And":[[{"Rule":30},{"Opt":{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":44}]]]}]]]}}],null]},{"And":[[{"Token":50}],null]}]},"replaceable":false}}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":{"ty_idx":88,"body":{"Or":[{"And":[[{"Token":53}],null]},{"And":[[{"Token":54}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":89,"body":{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":30},{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":50}]]]}]]]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":91,"body":{"Or":[{"And":[[{"Rule":30}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":92,"body":{"Or":[{"And":[[{"Token":25},{"Token":26}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":93,"body":{"Or":[{"And":[[{"Token":25},{"Call":[{"Rule":47},[[0,{"Rule":45}]]]},{"Opt":{"Rule":54}},{"Token":26}],null]}]},"replaceable":true}}}},{"Atom":{"body":{"Pub":{"ty_idx":95,"body":{"Or":[{"And":[[{"Opt":{"Token":23}},{"Token":49},{"Rep":{"Rule":56}},{"Token":49},{"Or":[{"And":[[{"Token":35},{"Rule":37},{"Rule":57}],null]},{"And":[[{"Call":[{"Rule":47},[[0,{"Rule":45}]]]}],null]}]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":96,"body":{"Or":[{"And":[[{"Call":[{"Rule":47},[[0,{"Call":[{"Rule":82},[[3,{"Or":[{"And":[[{"Rep":{"Rule":58}},{"Opt":{"Rule":45}}],null]}]}]]]}]]]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":100,"body":{"Or":[{"And":[[{"Token":12},{"Rule":64},{"Rule":57},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":57}],null]}]}}],1]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":101,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":51},{"Token":38}],null]}]}},{"Token":22},{"Rule":64},{"Rule":57}],2]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":102,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":51},{"Token":38}],null]}]}},{"Token":21},{"Rule":57}],2]}]},"replaceable":false}}}},{"Postfix":{"ty":103,"op":{"Call":[{"Rule":47},[[0,{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":68}]]]}]]]}]]]}}},{"Postfix":{"ty":104,"op":{"Or":[{"And":[[{"Token":41},{"Or":[{"And":[[{"Token":52}],null]},{"And":[[{"Token":53}],null]}]}],null]}]}}},{"Prefix":{"ty":106,"op":{"Token":48}}},{"Prefix":{"ty":107,"op":{"Token":43}}},{"Prefix":{"ty":108,"op":{"Token":47}}},{"Binary":{"ty":109,"op":{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"Token":43}],null]},{"And":[[{"Token":44}],null]},{"And":[[{"Token":45}],null]}]}]]]},"priority":5}},{"Binary":{"ty":110,"op":{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"Token":46}],null]},{"And":[[{"Token":47}],null]}]}]]]},"priority":4}},{"Binary":{"ty":111,"op":{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"ContextualToken":[33,"<<"]}],null]},{"And":[[{"ContextualToken":[34,">>"]}],null]}]}]]]},"priority":3}},{"Binary":{"ty":112,"op":{"Call":[{"Rule":75},[[1,{"Token":48}]]]},"priority":2}},{"Binary":{"ty":113,"op":{"Call":[{"Rule":75},[[1,{"Token":49}]]]},"priority":1}}]}},{"body":{"Or":[{"And":[[{"PrevIs":[100,96]}],null]}]}},{"body":{"Or":[{"And":[[{"Exit":[5,{"Exit":[4,{"Var":0}]}]}],null]}]}},{"body":{"Pub":{"ty_idx":88,"body":{"Or":[{"And":[[{"Token":53}],null]},{"And":[[{"Token":54}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":89,"body":{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":30},{"Call":[{"Rule":82},[[3,{"Call":[{"Rule":81},[[2,{"Rule":50}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":90,"body":{"Or":[{"And":[[{"Token":52},{"Token":38},{"Rule":45}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":91,"body":{"Or":[{"And":[[{"Rule":30}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":92,"body":{"Or":[{"And":[[{"Token":25},{"Token":26}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":93,"body":{"Or":[{"And":[[{"Token":25},{"Call":[{"Rule":47},[[0,{"Rule":45}]]]},{"Opt":{"Rule":54}},{"Token":26}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":94,"body":{"Or":[{"And":[[{"Token":40},{"Call":[{"Rule":81},[[2,{"Call":[{"Rule":47},[[0,{"Rule":45}]]]}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":95,"body":{"Or":[{"And":[[{"Opt":{"Token":23}},{"Token":49},{"Rep":{"Rule":56}},{"Token":49},{"Or":[{"And":[[{"Token":35},{"Rule":37},{"Rule":57}],null]},{"And":[[{"Call":[{"Rule":47},[[0,{"Rule":45}]]]}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":11},{"Or":[{"And":[[{"Token":40}],null]},{"And":[[{"Not":{"Not":{"Token":49}}}],null]}]}],1]}]}},{"body":{"Pub":{"ty_idx":96,"body":{"Or":[{"And":[[{"Call":[{"Rule":47},[[0,{"Call":[{"Rule":82},[[3,{"Or":[{"And":[[{"Rep":{"Rule":58}},{"Opt":{"Rule":45}}],null]}]}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":59}],null]},{"And":[[{"Rule":61}],null]},{"And":[[{"Rule":60}],null]}]}},{"body":{"Pub":{"ty_idx":97,"body":{"Or":[{"And":[[{"Token":7},{"Rule":44},{"Token":36},{"Rule":45},{"Token":37}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":98,"body":{"Or":[{"And":[[{"Token":37}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":99,"body":{"Or":[{"And":[[{"Enter":[4,{"Or":[{"And":[[{"Rule":45},{"Or":[{"And":[[{"Rule":46},{"Not":"Eof"}],null]},{"And":[[{"Token":37}],null]}]}],null]}]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":100,"body":{"Or":[{"And":[[{"Token":12},{"Rule":64},{"Rule":57},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":57}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":101,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":51},{"Token":38}],null]}]}},{"Token":22},{"Rule":64},{"Rule":57}],2]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Enter":[5,{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":7},{"Rule":44},{"Token":36}],1]}]}},{"Rule":45}],null]}]}]}],null]}]}},{"body":{"Pub":{"ty_idx":102,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":51},{"Token":38}],null]}]}},{"Token":21},{"Rule":57}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":103,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":47},[[0,{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":68}]]]}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":104,"body":{"Or":[{"And":[[{"Rule":45},{"Or":[{"And":[[{"Token":41},{"Or":[{"And":[[{"Token":52}],null]},{"And":[[{"Token":53}],null]}]}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":105,"body":{"Or":[{"And":[[{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":106,"body":{"Or":[{"And":[[{"Token":48},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":107,"body":{"Or":[{"And":[[{"Token":43},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":108,"body":{"Or":[{"And":[[{"Token":47},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":109,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"Token":43}],null]},{"And":[[{"Token":44}],null]},{"And":[[{"Token":45}],null]}]}]]]},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":110,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"Token":46}],null]},{"And":[[{"Token":47}],null]}]}]]]},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":111,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":75},[[1,{"Or":[{"And":[[{"ContextualToken":[33,"<<"]}],null]},{"And":[[{"ContextualToken":[34,">>"]}],null]}]}]]]},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"IsIn":4},{"Not":{"Rule":46}},{"Var":1}],null]},{"And":[[{"Not":{"IsIn":4}},{"Var":1}],null]}]}},{"body":{"Pub":{"ty_idx":112,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":75},[[1,{"Token":48}]]]},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":113,"body":{"Or":[{"And":[[{"Rule":45},{"Call":[{"Rule":75},[[1,{"Token":49}]]]},{"Rule":45}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":114,"body":{"Or":[{"And":[[{"Token":42},{"Call":[{"Rule":85},[[6,{"Call":[{"Rule":81},[[2,{"Rule":80}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"Rule":78}}],null]}]}},{"body":{"Pub":{"ty_idx":115,"body":{"Or":[{"And":[[{"Token":52},{"Opt":{"Or":[{"And":[[{"Token":36},{"Rule":45}],null]},{"And":[[{"Call":[{"Rule":83},[[4,{"Call":[{"Rule":81},[[2,{"Rule":80}]]]}]]]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":2},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":40}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":86},[[7,{"Token":27}],[8,{"Token":28}],[9,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":86},[[7,{"Token":25}],[8,{"Token":26}],[9,{"Var":4}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":86},[[7,{"Token":29}],[8,{"Token":30}],[9,{"Var":5}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":86},[[7,{"Token":31}],[8,{"Token":32}],[9,{"Var":6}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":7},{"Layer":[{"Call":[{"Rule":87},[[10,{"Var":7}],[11,{"Var":8}]]]},{"Var":9}]},{"Var":8}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":10},{"Call":[{"Rule":87},[[10,{"Var":10}],[11,{"Var":11}]]]},{"Var":11}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":11}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
