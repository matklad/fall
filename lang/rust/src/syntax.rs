...
pub const PATH_EXPR: NodeType = NodeType(155);
pub const BLOCK_EXPR: NodeType = NodeType(156);
pub const LET_STMT: NodeType = NodeType(157);
pub const EXPR_STMT: NodeType = NodeType(158);
pub const IF_EXPR: NodeType = NodeType(159);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, LPAREN, RPAREN, LBRACE, RBRACE, LANGLE, RANGLE, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, PLUS, MINUS, STAR, SLASH, PERCENT, UNDERSCORE, IDENT, NUMBER, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, STRUCT_DEF, MOD_DEF, STRUCT_FIELD, TUPLE_FIELD, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE, PATTERN, EXPR, PRODUCT_EXPR, SUM_EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PATH_EXPR, BLOCK_EXPR, LET_STMT, EXPR_STMT, IF_EXPR,
        ];
        let parser_json = r##"[{"body":{"Pub":[33,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":7}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":8}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"Token":4}],null]},{"And":[[{"Token":10}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":11}],null]},{"And":[[{"Rule":12}],null]}]}},{"body":{"Pub":[34,{"Or":[{"And":[[{"Token":9},{"Or":[{"And":[[{"Rule":16},{"Or":[{"And":[[{"Rule":24}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":23},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":23}},{"Rule":5}],null]}]},{"Token":21}],1]}]}]}},{"body":{"Pub":[35,{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Call":[{"Rule":40},[[1,{"Call":[{"Rule":39},[[0,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[36,{"Or":[{"And":[[{"Token":31},{"Opt":{"Rule":24}}],1]}]}]}},{"body":{"Pub":[37,{"Or":[{"And":[[{"Token":4},{"Token":3},{"Token":31},{"Opt":{"Rule":24}},{"Token":21}],2]}]}]}},{"body":{"Pub":[38,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":5},{"Token":31},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":19},{"Rule":25}],null]}]}},{"Rule":34}],2]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":41},[[2,{"Call":[{"Rule":39},[[0,{"Rule":10}]]]}]]]}],null]}]}},{"body":{"Pub":[39,{"Or":[{"And":[[{"Rule":26},{"Token":22},{"Rule":25}],null]}]}]}},{"body":{"Pub":[40,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":8},{"Token":31},{"Or":[{"And":[[{"Call":[{"Rule":40},[[1,{"Call":[{"Rule":39},[[0,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Token":21}],null]},{"And":[[{"Call":[{"Rule":41},[[2,{"Call":[{"Rule":39},[[0,{"Rule":14}]]]}]]]},{"Token":21}],null]}]}],2]}]}]}},{"body":{"Pub":[41,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":10},{"Token":31},{"Or":[{"And":[[{"Token":21}],null]},{"And":[[{"Call":[{"Rule":40},[[1,{"Rule":1}]]]}],null]}]}],2]}]}]}},{"body":{"Pub":[42,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":31},{"Token":22},{"Rule":25}],2]}]}]}},{"body":{"Pub":[43,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Rule":25}],null]}]}]}},{"body":{"Pub":[44,{"Or":[{"And":[[{"Token":7}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":19}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":19}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":19}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[45,{"Or":[{"And":[[{"Opt":{"Token":23}},{"Rule":22}],null]}]}]}}},{"Postfix":{"ty":45,"op":{"Or":[{"And":[[{"Token":23},{"Rule":22}],null]}]}}}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Opt":{"Token":23}},{"Rule":22}],null]}]}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Rule":19},{"Or":[{"And":[[{"Token":23},{"Rule":22}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":31},{"Opt":{"Rule":23}}],null]}]}},{"body":{"Pub":[46,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":23}],null]}]},{"Call":[{"Rule":42},[[3,{"Call":[{"Rule":39},[[0,{"Rule":25}]]]}]]]}],null]}]}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Token":2},{"Token":31}],null]}]}]}},{"body":{"Pub":[48,{"Or":[{"And":[[{"Rule":17}],null]}]}]}},{"body":{"Pub":[49,{"Or":[{"And":[[{"Token":31}],null]},{"And":[[{"Token":30}],null]}]}]}},{"body":{"Pratt":[{"Binary":{"ty":52,"op":{"Or":[{"And":[[{"Token":25}],null]},{"And":[[{"Token":26}],null]}]},"priority":1}},{"Binary":{"ty":51,"op":{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},"priority":2}},{"Atom":{"body":{"Pub":[60,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":27}]},{"Rule":34},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":34}],null]}]}}],1]}]}]}}},{"Atom":{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":32}],null]}]}]}}},{"Atom":{"body":{"Pub":[54,{"Or":[{"And":[[{"NotAhead":{"IsIn":4}},{"Rule":18},{"Call":[{"Rule":40},[[1,{"Call":[{"Rule":39},[[0,{"Rule":32}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[56,{"Or":[{"And":[[{"Rule":18}],null]}]}]}}},{"Atom":{"body":{"Pub":[57,{"Or":[{"And":[[{"Call":[{"Rule":40},[[1,{"Or":[{"And":[[{"Rep":{"Rule":35}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}}}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Rule":27},{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},{"Rule":27}],null]}]}]}},{"body":{"Pub":[52,{"Or":[{"And":[[{"Rule":27},{"Or":[{"And":[[{"Token":25}],null]},{"And":[[{"Token":26}],null]}]},{"Rule":27}],null]}]}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":32}],null]}]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"NotAhead":{"IsIn":4}},{"Rule":18},{"Call":[{"Rule":40},[[1,{"Call":[{"Rule":39},[[0,{"Rule":32}]]]}]]]}],null]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Token":31},{"Token":22},{"Rule":27}],1]}]}]}},{"body":{"Pub":[56,{"Or":[{"And":[[{"Rule":18}],null]}]}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Call":[{"Rule":40},[[1,{"Or":[{"And":[[{"Rep":{"Rule":35}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":36}],null]},{"And":[[{"Rule":37}],null]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Token":6},{"Rule":26},{"Token":20},{"Rule":27},{"Token":21}],1]}]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Rule":27},{"Token":21}],null]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":27}]},{"Rule":34},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":34}],null]}]}}],1]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":0},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":24}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":43},[[4,{"Token":15}],[5,{"Token":16}],[6,{"Var":1}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":43},[[4,{"Token":13}],[5,{"Token":14}],[6,{"Var":2}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":43},[[4,{"Token":17}],[5,{"Token":18}],[6,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":4},{"Layer":[{"Call":[{"Rule":44},[[7,{"Var":4}],[8,{"Var":5}]]]},{"Var":6}]},{"Var":5}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":7},{"Call":[{"Rule":44},[[7,{"Var":7}],[8,{"Var":8}]]]},{"Var":8}],1]},{"And":[[{"Not":{"Var":8}}],null]}]}}],null]}]}}]"##;
