...
pub const STRING: NodeType = NodeType(146);
pub const FILE: NodeType = NodeType(147);
pub const USE_DECL: NodeType = NodeType(148);
pub const USE_SPEC: NodeType = NodeType(149);
pub const USE_SPEC_ENTRY: NodeType = NodeType(150);
pub const EXTERN_CRATE_DECL: NodeType = NodeType(151);
pub const FN_DEF: NodeType = NodeType(152);
pub const VALUE_PARAM: NodeType = NodeType(153);
pub const SELF_PARAMETER: NodeType = NodeType(154);
pub const STRUCT_DEF: NodeType = NodeType(155);
pub const STRUCT_FIELD: NodeType = NodeType(156);
pub const TUPLE_FIELD: NodeType = NodeType(157);
pub const ENUM_DEF: NodeType = NodeType(158);
pub const ENUM_VARIANT: NodeType = NodeType(159);
pub const MOD_DEF: NodeType = NodeType(160);
pub const IMPL_DEF: NodeType = NodeType(161);
pub const TYPE_DEF: NodeType = NodeType(162);
pub const TYPE_PARAMETERS: NodeType = NodeType(163);
pub const TYPE_PARAMETER: NodeType = NodeType(164);
pub const VISIBILITY: NodeType = NodeType(165);
pub const PATH: NodeType = NodeType(166);
pub const TYPE_ARGUMENTS: NodeType = NodeType(167);
pub const ALIAS: NodeType = NodeType(168);
pub const TYPE_REFERENCE: NodeType = NodeType(169);
pub const PATTERN: NodeType = NodeType(170);
pub const EXPR: NodeType = NodeType(171);
pub const LITERAL: NodeType = NodeType(172);
pub const STRUCT_LITERAL: NodeType = NodeType(173);
pub const STRUCT_LITERAL_FIELD: NodeType = NodeType(174);
pub const PAREN_EXPR: NodeType = NodeType(175);
pub const PATH_EXPR: NodeType = NodeType(176);
pub const BLOCK_EXPR: NodeType = NodeType(177);
pub const LET_STMT: NodeType = NodeType(178);
pub const EMPTY_STMT: NodeType = NodeType(179);
pub const EXPR_STMT: NodeType = NodeType(180);
pub const IF_EXPR: NodeType = NodeType(181);
pub const CALL_EXPR: NodeType = NodeType(182);
pub const FIELD_EXPR: NodeType = NodeType(183);
pub const VALUE_ARGUMENT: NodeType = NodeType(184);
pub const REFERENCE_EXPR: NodeType = NodeType(185);
pub const DEREFERENCE_EXPR: NodeType = NodeType(186);
pub const NEGATION_EXPR: NodeType = NodeType(187);
pub const PRODUCT_EXPR: NodeType = NodeType(188);
pub const SUM_EXPR: NodeType = NodeType(189);
pub const BIT_SHIFT: NodeType = NodeType(190);
pub const BIT_AND: NodeType = NodeType(191);
pub const BIT_OR: NodeType = NodeType(192);
pub const ATTRIBUTE: NodeType = NodeType(193);
pub const ATTR_VALUE: NodeType = NodeType(194);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, UNION, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, ENUM, IMPL, SELF, SUPER, TYPE, L_PAREN, R_PAREN, L_CURLY, R_CURLY, L_ANGLE, R_ANGLE, L_BRACK, R_BRACK, SHL, SHR, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, DOT, HASH, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, IDENT, NUMBER, STRING, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, SELF_PARAMETER, STRUCT_DEF, STRUCT_FIELD, TUPLE_FIELD, ENUM_DEF, ENUM_VARIANT, MOD_DEF, IMPL_DEF, TYPE_DEF, TYPE_PARAMETERS, TYPE_PARAMETER, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE_REFERENCE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PAREN_EXPR, PATH_EXPR, BLOCK_EXPR, LET_STMT, EMPTY_STMT, EXPR_STMT, IF_EXPR, CALL_EXPR, FIELD_EXPR, VALUE_ARGUMENT, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR, ATTRIBUTE, ATTR_VALUE,
        ];
        let parser_json = r##"[{"body":{"Pub":[48,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":36}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]},{"And":[[{"Token":14}],null]},{"And":[[{"Token":10}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":15}],null]},{"And":[[{"Token":18}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":12}],null]},{"And":[[{"Rule":15}],null]},{"And":[[{"Rule":17}],null]},{"And":[[{"Rule":18}],null]},{"And":[[{"Rule":21}],null]}]}},{"body":{"Pub":[49,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Token":10},{"Or":[{"And":[[{"Rule":25},{"Or":[{"And":[[{"Rule":33}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":33},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":33}},{"Rule":5}],null]}]},{"Token":31}],3]}]}]}},{"body":{"Pub":[50,{"Or":[{"And":[[{"Token":37}],null]},{"And":[[{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Token":45},{"Opt":{"Rule":33}}],1]}]}]}},{"body":{"Pub":[52,{"Or":[{"And":[[{"Rule":63},{"Token":5},{"Token":4},{"Token":45},{"Opt":{"Rule":33}},{"Token":31}],3]}]}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Token":6},{"Token":45},{"Opt":{"Rule":22}},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":29},{"Rule":34}],null]}]}},{"Rule":44}],3]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":67},[[4,{"Or":[{"And":[[{"Opt":{"Rule":11}},{"Call":[{"Rule":65},[[2,{"Rule":10}]]]}],null]}]}]]]}],null]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"Rule":35},{"Token":32},{"Rule":34}],null]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Opt":{"Token":42}},{"Token":16},{"Or":[{"And":[[{"Token":34}],null]},{"And":[["Eof"],null]}]}],2]}]}]}},{"body":{"Pub":[56,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Or":[{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]}]},{"Token":45},{"Opt":{"Rule":22}},{"Or":[{"And":[[{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Token":31}],null]},{"And":[[{"Call":[{"Rule":67},[[4,{"Call":[{"Rule":65},[[2,{"Rule":14}]]]}]]]},{"Token":31}],null]}]}],3]}]}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Opt":{"Rule":24}},{"Token":45},{"Token":32},{"Rule":34}],2]}]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Opt":{"Rule":24}},{"Rule":34}],null]}]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Token":14},{"Token":45},{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":16}]]]}]]]}],3]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Token":45},{"Opt":{"Or":[{"And":[[{"Token":30},{"Rule":36}],null]},{"And":[[{"Call":[{"Rule":67},[[4,{"Call":[{"Rule":65},[[2,{"Rule":14}]]]}]]]}],null]},{"And":[[{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":13}]]]}]]]}],null]}]}}],1]}]}]}},{"body":{"Pub":[61,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Token":11},{"Token":45},{"Or":[{"And":[[{"Token":31}],null]},{"And":[[{"Call":[{"Rule":66},[[3,{"Rule":1}]]]}],null]}]}],3]}]}]}},{"body":{"Pub":[62,{"Or":[{"And":[[{"Rule":63},{"Token":15},{"Token":45},{"Call":[{"Rule":66},[[3,{"Rep":{"WithSkip":[{"Rule":20},{"Rule":19}]}}]]]}],2]}]}]}},{"body":{"Or":[{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":21}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":18}],null]}]}},{"body":{"Pub":[63,{"Or":[{"And":[[{"Rule":63},{"Opt":{"Rule":24}},{"Token":18},{"Token":45},{"Opt":{"Rule":22}},{"Opt":{"Or":[{"And":[[{"Token":30},{"Rule":34}],null]}]}},{"Token":31}],3]}]}]}},{"body":{"Pub":[64,{"Or":[{"And":[[{"Call":[{"Rule":68},[[5,{"Call":[{"Rule":65},[[2,{"Rule":23}]]]}]]]}],null]}]}]}},{"body":{"Pub":[65,{"Or":[{"And":[[{"Token":45}],null]}]}]}},{"body":{"Pub":[66,{"Or":[{"And":[[{"Token":8}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":28}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":28}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":28}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[67,{"Or":[{"And":[[{"Opt":{"Token":33}},{"Rule":31}],null]}]}]}}},{"Postfix":{"ty":67,"op":{"Or":[{"And":[[{"Token":33},{"Rule":31}],null]}]}}}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Opt":{"Token":33}},{"Rule":31}],null]}]}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Rule":28},{"Or":[{"And":[[{"Token":33},{"Rule":31}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":45}],null]},{"And":[[{"Token":16}],null]},{"And":[[{"Token":17}],null]}]},{"Opt":{"Rule":32}}],null]}]}},{"body":{"Pub":[68,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":33}],null]}]},{"Call":[{"Rule":68},[[5,{"Call":[{"Rule":65},[[2,{"Rule":34}]]]}]]]}],null]}]}]}},{"body":{"Pub":[69,{"Or":[{"And":[[{"Token":3},{"Token":45}],null]}]}]}},{"body":{"Pub":[70,{"Or":[{"And":[[{"Rule":26}],null]},{"And":[[{"Token":42},{"Rule":34}],null]}]}]}},{"body":{"Pub":[71,{"Or":[{"And":[[{"Token":45}],null]},{"And":[[{"Token":44}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[73,{"Or":[{"And":[[{"Token":46}],null]},{"And":[[{"Token":47}],null]}]}]}}},{"Atom":{"body":{"Pub":[74,{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":27},{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":41}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[77,{"Or":[{"And":[[{"Rule":27}],null]}]}]}}},{"Atom":{"body":{"Pub":[76,{"Or":[{"And":[[{"Token":19},{"Call":[{"Rule":38},[[0,{"Rule":36}]]]},{"Token":20}],null]}]}]}}},{"Atom":{"body":{"Pub":[78,{"Or":[{"And":[[{"Call":[{"Rule":38},[[0,{"Call":[{"Rule":66},[[3,{"Or":[{"And":[[{"Rep":{"Rule":45}},{"Opt":{"Rule":36}}],null]}]}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[82,{"Or":[{"And":[[{"Token":12},{"Enter":[5,{"Rule":36}]},{"Rule":44},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":44}],null]}]}}],1]}]}]}}},{"Postfix":{"ty":83,"op":{"Call":[{"Rule":38},[[0,{"Call":[{"Rule":67},[[4,{"Call":[{"Rule":65},[[2,{"Rule":52}]]]}]]]}]]]}}},{"Postfix":{"ty":84,"op":{"Or":[{"And":[[{"Token":35},{"Token":45}],null]}]}}},{"Prefix":{"ty":86,"op":{"Token":42}}},{"Prefix":{"ty":87,"op":{"Token":37}}},{"Prefix":{"ty":88,"op":{"Token":41}}},{"Binary":{"ty":89,"op":{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"Token":37}],null]},{"And":[[{"Token":38}],null]},{"And":[[{"Token":39}],null]}]}]]]},"priority":5}},{"Binary":{"ty":90,"op":{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"Token":40}],null]},{"And":[[{"Token":41}],null]}]}]]]},"priority":4}},{"Binary":{"ty":91,"op":{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"ContextualToken":[27,"<<"]}],null]},{"And":[[{"ContextualToken":[28,">>"]}],null]}]}]]]},"priority":3}},{"Binary":{"ty":92,"op":{"Call":[{"Rule":59},[[1,{"Token":42}]]]},"priority":2}},{"Binary":{"ty":93,"op":{"Call":[{"Rule":59},[[1,{"Token":43}]]]},"priority":1}}]}},{"body":{"Or":[{"And":[[{"PrevIs":[82,78]}],null]}]}},{"body":{"Or":[{"And":[[{"Exit":[5,{"Exit":[4,{"Var":0}]}]}],null]}]}},{"body":{"Pub":[73,{"Or":[{"And":[[{"Token":46}],null]},{"And":[[{"Token":47}],null]}]}]}},{"body":{"Pub":[74,{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":27},{"Call":[{"Rule":66},[[3,{"Call":[{"Rule":65},[[2,{"Rule":41}]]]}]]]}],null]}]}]}},{"body":{"Pub":[75,{"Or":[{"And":[[{"Token":45},{"Token":32},{"Rule":36}],1]}]}]}},{"body":{"Pub":[76,{"Or":[{"And":[[{"Token":19},{"Call":[{"Rule":38},[[0,{"Rule":36}]]]},{"Token":20}],null]}]}]}},{"body":{"Pub":[77,{"Or":[{"And":[[{"Rule":27}],null]}]}]}},{"body":{"Pub":[78,{"Or":[{"And":[[{"Call":[{"Rule":38},[[0,{"Call":[{"Rule":66},[[3,{"Or":[{"And":[[{"Rep":{"Rule":45}},{"Opt":{"Rule":36}}],null]}]}]]]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":46}],null]},{"And":[[{"Rule":48}],null]},{"And":[[{"Rule":47}],null]}]}},{"body":{"Pub":[79,{"Or":[{"And":[[{"Token":7},{"Rule":35},{"Token":30},{"Rule":36},{"Token":31}],1]}]}]}},{"body":{"Pub":[80,{"Or":[{"And":[[{"Token":31}],null]}]}]}},{"body":{"Pub":[81,{"Or":[{"And":[[{"Enter":[4,{"Or":[{"And":[[{"Rule":36},{"Or":[{"And":[[{"Rule":37},{"Not":"Eof"}],null]},{"And":[[{"Token":31}],null]}]}],null]}]}]}],null]}]}]}},{"body":{"Pub":[82,{"Or":[{"And":[[{"Token":12},{"Enter":[5,{"Rule":36}]},{"Rule":44},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":44}],null]}]}}],1]}]}]}},{"body":{"Pub":[83,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":38},[[0,{"Call":[{"Rule":67},[[4,{"Call":[{"Rule":65},[[2,{"Rule":52}]]]}]]]}]]]}],null]}]}]}},{"body":{"Pub":[84,{"Or":[{"And":[[{"Rule":36},{"Or":[{"And":[[{"Token":35},{"Token":45}],null]}]}],null]}]}]}},{"body":{"Pub":[85,{"Or":[{"And":[[{"Rule":36}],null]}]}]}},{"body":{"Pub":[86,{"Or":[{"And":[[{"Token":42},{"Rule":36}],null]}]}]}},{"body":{"Pub":[87,{"Or":[{"And":[[{"Token":37},{"Rule":36}],null]}]}]}},{"body":{"Pub":[88,{"Or":[{"And":[[{"Token":41},{"Rule":36}],null]}]}]}},{"body":{"Pub":[89,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"Token":37}],null]},{"And":[[{"Token":38}],null]},{"And":[[{"Token":39}],null]}]}]]]},{"Rule":36}],null]}]}]}},{"body":{"Pub":[90,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"Token":40}],null]},{"And":[[{"Token":41}],null]}]}]]]},{"Rule":36}],null]}]}]}},{"body":{"Pub":[91,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":59},[[1,{"Or":[{"And":[[{"ContextualToken":[27,"<<"]}],null]},{"And":[[{"ContextualToken":[28,">>"]}],null]}]}]]]},{"Rule":36}],null]}]}]}},{"body":{"Or":[{"And":[[{"IsIn":4},{"Not":{"Rule":37}},{"Var":1}],null]},{"And":[[{"Not":{"IsIn":4}},{"Var":1}],null]}]}},{"body":{"Pub":[92,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":59},[[1,{"Token":42}]]]},{"Rule":36}],null]}]}]}},{"body":{"Pub":[93,{"Or":[{"And":[[{"Rule":36},{"Call":[{"Rule":59},[[1,{"Token":43}]]]},{"Rule":36}],null]}]}]}},{"body":{"Pub":[94,{"Or":[{"And":[[{"Token":36},{"Call":[{"Rule":69},[[6,{"Call":[{"Rule":65},[[2,{"Rule":64}]]]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Rule":62}}],null]}]}},{"body":{"Pub":[95,{"Or":[{"And":[[{"Token":45},{"Opt":{"Or":[{"And":[[{"Token":30},{"Rule":36}],null]},{"And":[[{"Call":[{"Rule":67},[[4,{"Call":[{"Rule":65},[[2,{"Rule":64}]]]}]]]}],null]}]}}],1]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":2},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":34}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":70},[[7,{"Token":21}],[8,{"Token":22}],[9,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":70},[[7,{"Token":19}],[8,{"Token":20}],[9,{"Var":4}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":70},[[7,{"Token":23}],[8,{"Token":24}],[9,{"Var":5}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":70},[[7,{"Token":25}],[8,{"Token":26}],[9,{"Var":6}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":7},{"Layer":[{"Call":[{"Rule":71},[[10,{"Var":7}],[11,{"Var":8}]]]},{"Var":9}]},{"Var":8}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":10},{"Call":[{"Rule":71},[[10,{"Var":10}],[11,{"Var":11}]]]},{"Var":11}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":11}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
