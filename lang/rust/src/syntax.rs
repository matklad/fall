...
pub const LIFETIME: NodeType = NodeType(145);
pub const IDENT: NodeType = NodeType(146);
pub const NUMBER: NodeType = NodeType(147);
pub const STRING: NodeType = NodeType(148);
pub const FILE: NodeType = NodeType(149);
pub const USE_DECL: NodeType = NodeType(150);
pub const USE_SPEC: NodeType = NodeType(151);
pub const USE_SPEC_ENTRY: NodeType = NodeType(152);
pub const EXTERN_CRATE_DECL: NodeType = NodeType(153);
pub const FN_DEF: NodeType = NodeType(154);
pub const VALUE_PARAM: NodeType = NodeType(155);
pub const SELF_PARAMETER: NodeType = NodeType(156);
pub const STRUCT_DEF: NodeType = NodeType(157);
pub const STRUCT_FIELD: NodeType = NodeType(158);
pub const TUPLE_FIELD: NodeType = NodeType(159);
pub const ENUM_DEF: NodeType = NodeType(160);
pub const ENUM_VARIANT: NodeType = NodeType(161);
pub const MOD_DEF: NodeType = NodeType(162);
pub const IMPL_DEF: NodeType = NodeType(163);
pub const TYPE_DEF: NodeType = NodeType(164);
pub const CONST_DEF: NodeType = NodeType(165);
pub const TYPE_PARAMETERS: NodeType = NodeType(166);
pub const TYPE_PARAMETER: NodeType = NodeType(167);
pub const LIFETIME_PARAMETER: NodeType = NodeType(168);
pub const VISIBILITY: NodeType = NodeType(169);
pub const PATH: NodeType = NodeType(170);
pub const TYPE_ARGUMENTS: NodeType = NodeType(171);
pub const ALIAS: NodeType = NodeType(172);
pub const TYPE_REFERENCE: NodeType = NodeType(173);
pub const PATTERN: NodeType = NodeType(174);
pub const EXPR: NodeType = NodeType(175);
pub const LITERAL: NodeType = NodeType(176);
pub const STRUCT_LITERAL: NodeType = NodeType(177);
pub const STRUCT_LITERAL_FIELD: NodeType = NodeType(178);
pub const PAREN_EXPR: NodeType = NodeType(179);
pub const PATH_EXPR: NodeType = NodeType(180);
pub const BLOCK_EXPR: NodeType = NodeType(181);
pub const LET_STMT: NodeType = NodeType(182);
pub const EMPTY_STMT: NodeType = NodeType(183);
pub const EXPR_STMT: NodeType = NodeType(184);
pub const IF_EXPR: NodeType = NodeType(185);
pub const CALL_EXPR: NodeType = NodeType(186);
pub const FIELD_EXPR: NodeType = NodeType(187);
pub const VALUE_ARGUMENT: NodeType = NodeType(188);
pub const REFERENCE_EXPR: NodeType = NodeType(189);
pub const DEREFERENCE_EXPR: NodeType = NodeType(190);
pub const NEGATION_EXPR: NodeType = NodeType(191);
pub const PRODUCT_EXPR: NodeType = NodeType(192);
pub const SUM_EXPR: NodeType = NodeType(193);
pub const BIT_SHIFT: NodeType = NodeType(194);
pub const BIT_AND: NodeType = NodeType(195);
pub const BIT_OR: NodeType = NodeType(196);
pub const ATTRIBUTE: NodeType = NodeType(197);
pub const ATTR_VALUE: NodeType = NodeType(198);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, UNION, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, ENUM, IMPL, SELF, SUPER, TYPE, CONST, L_PAREN, R_PAREN, L_CURLY, R_CURLY, L_ANGLE, R_ANGLE, L_BRACK, R_BRACK, SHL, SHR, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, DOT, HASH, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, LIFETIME, IDENT, NUMBER, STRING, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, SELF_PARAMETER, STRUCT_DEF, STRUCT_FIELD, TUPLE_FIELD, ENUM_DEF, ENUM_VARIANT, MOD_DEF, IMPL_DEF, TYPE_DEF, CONST_DEF, TYPE_PARAMETERS, TYPE_PARAMETER, LIFETIME_PARAMETER, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE_REFERENCE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PAREN_EXPR, PATH_EXPR, BLOCK_EXPR, LET_STMT, EMPTY_STMT, EXPR_STMT, IF_EXPR, CALL_EXPR, FIELD_EXPR, VALUE_ARGUMENT, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR, ATTRIBUTE, ATTR_VALUE,
        ];
        let parser_json = r##"[{"body":{"Pub":[50,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":37}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]},{"And":[[{"Token":14}],null]},{"And":[[{"Token":10}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":15}],null]},{"And":[[{"Token":18}],null]},{"And":[[{"Token":19}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":12}],null]},{"And":[[{"Rule":15}],null]},{"And":[[{"Rule":17}],null]},{"And":[[{"Rule":18}],null]},{"And":[[{"Rule":21}],null]},{"And":[[{"Rule":22}],null]}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":10},{"Or":[{"And":[[{"Rule":27},{"Or":[{"And":[[{"Rule":35}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":34},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":34}},{"Rule":5}],null]}]},{"Token":32}],3]}]}]}},{"body":{"Pub":[52,{"Or":[{"And":[[{"Token":38}],null]},{"And":[[{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":47},{"Opt":{"Rule":35}}],1]}]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"Rule":65},{"Token":5},{"Token":4},{"Token":47},{"Opt":{"Rule":35}},{"Token":32}],3]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":6},{"Token":47},{"Opt":{"Rule":23}},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":30},{"Rule":36}],null]}]}},{"Rule":46}],3]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":69},[[4,{"Or":[{"And":[[{"Opt":{"Rule":11}},{"Call":[{"Rule":67},[[2,{"Rule":10}]]]}],null]}]}]]]}],null]}]}},{"body":{"Pub":[56,{"Or":[{"And":[[{"Rule":37},{"Token":33},{"Rule":36}],null]}]}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Opt":{"Token":43}},{"Token":16},{"Or":[{"And":[[{"Token":35}],null]},{"And":[["Eof"],null]}]}],2]}]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Or":[{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]}]},{"Token":47},{"Opt":{"Rule":23}},{"Or":[{"And":[[{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Token":32}],null]},{"And":[[{"Call":[{"Rule":69},[[4,{"Call":[{"Rule":67},[[2,{"Rule":14}]]]}]]]},{"Token":32}],null]}]}],3]}]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Opt":{"Rule":26}},{"Token":47},{"Token":33},{"Rule":36}],2]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Opt":{"Rule":26}},{"Rule":36}],null]}]}]}},{"body":{"Pub":[61,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":14},{"Token":47},{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":16}]]]}]]]}],3]}]}]}},{"body":{"Pub":[62,{"Or":[{"And":[[{"Token":47},{"Opt":{"Or":[{"And":[[{"Token":31},{"Rule":38}],null]},{"And":[[{"Call":[{"Rule":69},[[4,{"Call":[{"Rule":67},[[2,{"Rule":14}]]]}]]]}],null]},{"And":[[{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":13}]]]}]]]}],null]}]}}],1]}]}]}},{"body":{"Pub":[63,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":11},{"Token":47},{"Or":[{"And":[[{"Token":32}],null]},{"And":[[{"Call":[{"Rule":68},[[3,{"Rule":1}]]]}],null]}]}],3]}]}]}},{"body":{"Pub":[64,{"Or":[{"And":[[{"Rule":65},{"Token":15},{"Token":47},{"Call":[{"Rule":68},[[3,{"Rep":{"WithSkip":[{"Rule":20},{"Rule":19}]}}]]]}],2]}]}]}},{"body":{"Or":[{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":21}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":18}],null]}]}},{"body":{"Pub":[65,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":18},{"Token":47},{"Opt":{"Rule":23}},{"Opt":{"Or":[{"And":[[{"Token":31},{"Rule":36}],null]}]}},{"Token":32}],3]}]}]}},{"body":{"Pub":[66,{"Or":[{"And":[[{"Rule":65},{"Opt":{"Rule":26}},{"Token":19},{"Token":47},{"Token":33},{"Rule":36},{"Token":31},{"Rule":38},{"Token":32}],3]}]}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Call":[{"Rule":70},[[5,{"Or":[{"And":[[{"Call":[{"Rule":67},[[2,{"Rule":25}]]]},{"Call":[{"Rule":67},[[2,{"Rule":24}]]]}],null]}]}]]]}],null]}]}]}},{"body":{"Pub":[68,{"Or":[{"And":[[{"Token":47}],null]}]}]}},{"body":{"Pub":[69,{"Or":[{"And":[[{"Token":46}],null]}]}]}},{"body":{"Pub":[70,{"Or":[{"And":[[{"Token":8}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":30}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":30}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":30}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[71,{"Or":[{"And":[[{"Opt":{"Token":34}},{"Rule":33}],null]}]}]}}},{"Postfix":{"ty":71,"op":{"Or":[{"And":[[{"Token":34},{"Rule":33}],null]}]}}}]}},{"body":{"Pub":[71,{"Or":[{"And":[[{"Opt":{"Token":34}},{"Rule":33}],null]}]}]}},{"body":{"Pub":[71,{"Or":[{"And":[[{"Rule":30},{"Or":[{"And":[[{"Token":34},{"Rule":33}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":47}],null]},{"And":[[{"Token":16}],null]},{"And":[[{"Token":17}],null]}]},{"Opt":{"Rule":34}}],null]}]}},{"body":{"Pub":[72,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":34}],null]}]},{"Call":[{"Rule":70},[[5,{"Or":[{"And":[[{"Call":[{"Rule":67},[[2,{"Token":46}]]]},{"Call":[{"Rule":67},[[2,{"Rule":36}]]]}],null]}]}]]]}],null]}]}]}},{"body":{"Pub":[73,{"Or":[{"And":[[{"Token":3},{"Token":47}],null]}]}]}},{"body":{"Pub":[74,{"Or":[{"And":[[{"Rule":28}],null]},{"And":[[{"Token":43},{"Opt":{"Token":46}},{"Rule":36}],null]}]}]}},{"body":{"Pub":[75,{"Or":[{"And":[[{"Token":47}],null]},{"And":[[{"Token":45}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[77,{"Or":[{"And":[[{"Token":48}],null]},{"And":[[{"Token":49}],null]}]}]}}},{"Atom":{"body":{"Pub":[78,{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":29},{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":43}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[81,{"Or":[{"And":[[{"Rule":29}],null]}]}]}}},{"Atom":{"body":{"Pub":[80,{"Or":[{"And":[[{"Token":20},{"Call":[{"Rule":40},[[0,{"Rule":38}]]]},{"Token":21}],null]}]}]}}},{"Atom":{"body":{"Pub":[82,{"Or":[{"And":[[{"Call":[{"Rule":40},[[0,{"Call":[{"Rule":68},[[3,{"Or":[{"And":[[{"Rep":{"Rule":47}},{"Opt":{"Rule":38}}],null]}]}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[86,{"Or":[{"And":[[{"Token":12},{"Enter":[5,{"Rule":38}]},{"Rule":46},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":46}],null]}]}}],1]}]}]}}},{"Postfix":{"ty":87,"op":{"Call":[{"Rule":40},[[0,{"Call":[{"Rule":69},[[4,{"Call":[{"Rule":67},[[2,{"Rule":54}]]]}]]]}]]]}}},{"Postfix":{"ty":88,"op":{"Or":[{"And":[[{"Token":36},{"Token":47}],null]}]}}},{"Prefix":{"ty":90,"op":{"Token":43}}},{"Prefix":{"ty":91,"op":{"Token":38}}},{"Prefix":{"ty":92,"op":{"Token":42}}},{"Binary":{"ty":93,"op":{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"Token":38}],null]},{"And":[[{"Token":39}],null]},{"And":[[{"Token":40}],null]}]}]]]},"priority":5}},{"Binary":{"ty":94,"op":{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"Token":41}],null]},{"And":[[{"Token":42}],null]}]}]]]},"priority":4}},{"Binary":{"ty":95,"op":{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"ContextualToken":[28,"<<"]}],null]},{"And":[[{"ContextualToken":[29,">>"]}],null]}]}]]]},"priority":3}},{"Binary":{"ty":96,"op":{"Call":[{"Rule":61},[[1,{"Token":43}]]]},"priority":2}},{"Binary":{"ty":97,"op":{"Call":[{"Rule":61},[[1,{"Token":44}]]]},"priority":1}}]}},{"body":{"Or":[{"And":[[{"PrevIs":[86,82]}],null]}]}},{"body":{"Or":[{"And":[[{"Exit":[5,{"Exit":[4,{"Var":0}]}]}],null]}]}},{"body":{"Pub":[77,{"Or":[{"And":[[{"Token":48}],null]},{"And":[[{"Token":49}],null]}]}]}},{"body":{"Pub":[78,{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Rule":29},{"Call":[{"Rule":68},[[3,{"Call":[{"Rule":67},[[2,{"Rule":43}]]]}]]]}],null]}]}]}},{"body":{"Pub":[79,{"Or":[{"And":[[{"Token":47},{"Token":33},{"Rule":38}],1]}]}]}},{"body":{"Pub":[80,{"Or":[{"And":[[{"Token":20},{"Call":[{"Rule":40},[[0,{"Rule":38}]]]},{"Token":21}],null]}]}]}},{"body":{"Pub":[81,{"Or":[{"And":[[{"Rule":29}],null]}]}]}},{"body":{"Pub":[82,{"Or":[{"And":[[{"Call":[{"Rule":40},[[0,{"Call":[{"Rule":68},[[3,{"Or":[{"And":[[{"Rep":{"Rule":47}},{"Opt":{"Rule":38}}],null]}]}]]]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":48}],null]},{"And":[[{"Rule":50}],null]},{"And":[[{"Rule":49}],null]}]}},{"body":{"Pub":[83,{"Or":[{"And":[[{"Token":7},{"Rule":37},{"Token":31},{"Rule":38},{"Token":32}],1]}]}]}},{"body":{"Pub":[84,{"Or":[{"And":[[{"Token":32}],null]}]}]}},{"body":{"Pub":[85,{"Or":[{"And":[[{"Enter":[4,{"Or":[{"And":[[{"Rule":38},{"Or":[{"And":[[{"Rule":39},{"Not":"Eof"}],null]},{"And":[[{"Token":32}],null]}]}],null]}]}]}],null]}]}]}},{"body":{"Pub":[86,{"Or":[{"And":[[{"Token":12},{"Enter":[5,{"Rule":38}]},{"Rule":46},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":46}],null]}]}}],1]}]}]}},{"body":{"Pub":[87,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":40},[[0,{"Call":[{"Rule":69},[[4,{"Call":[{"Rule":67},[[2,{"Rule":54}]]]}]]]}]]]}],null]}]}]}},{"body":{"Pub":[88,{"Or":[{"And":[[{"Rule":38},{"Or":[{"And":[[{"Token":36},{"Token":47}],null]}]}],null]}]}]}},{"body":{"Pub":[89,{"Or":[{"And":[[{"Rule":38}],null]}]}]}},{"body":{"Pub":[90,{"Or":[{"And":[[{"Token":43},{"Rule":38}],null]}]}]}},{"body":{"Pub":[91,{"Or":[{"And":[[{"Token":38},{"Rule":38}],null]}]}]}},{"body":{"Pub":[92,{"Or":[{"And":[[{"Token":42},{"Rule":38}],null]}]}]}},{"body":{"Pub":[93,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"Token":38}],null]},{"And":[[{"Token":39}],null]},{"And":[[{"Token":40}],null]}]}]]]},{"Rule":38}],null]}]}]}},{"body":{"Pub":[94,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"Token":41}],null]},{"And":[[{"Token":42}],null]}]}]]]},{"Rule":38}],null]}]}]}},{"body":{"Pub":[95,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":61},[[1,{"Or":[{"And":[[{"ContextualToken":[28,"<<"]}],null]},{"And":[[{"ContextualToken":[29,">>"]}],null]}]}]]]},{"Rule":38}],null]}]}]}},{"body":{"Or":[{"And":[[{"IsIn":4},{"Not":{"Rule":39}},{"Var":1}],null]},{"And":[[{"Not":{"IsIn":4}},{"Var":1}],null]}]}},{"body":{"Pub":[96,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":61},[[1,{"Token":43}]]]},{"Rule":38}],null]}]}]}},{"body":{"Pub":[97,{"Or":[{"And":[[{"Rule":38},{"Call":[{"Rule":61},[[1,{"Token":44}]]]},{"Rule":38}],null]}]}]}},{"body":{"Pub":[98,{"Or":[{"And":[[{"Token":37},{"Call":[{"Rule":71},[[6,{"Call":[{"Rule":67},[[2,{"Rule":66}]]]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Rule":64}}],null]}]}},{"body":{"Pub":[99,{"Or":[{"And":[[{"Token":47},{"Opt":{"Or":[{"And":[[{"Token":31},{"Rule":38}],null]},{"And":[[{"Call":[{"Rule":69},[[4,{"Call":[{"Rule":67},[[2,{"Rule":66}]]]}]]]}],null]}]}}],1]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":2},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":35}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":72},[[7,{"Token":22}],[8,{"Token":23}],[9,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":72},[[7,{"Token":20}],[8,{"Token":21}],[9,{"Var":4}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":72},[[7,{"Token":24}],[8,{"Token":25}],[9,{"Var":5}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":72},[[7,{"Token":26}],[8,{"Token":27}],[9,{"Var":6}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":7},{"Layer":[{"Call":[{"Rule":73},[[10,{"Var":7}],[11,{"Var":8}]]]},{"Var":9}]},{"Var":8}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":10},{"Call":[{"Rule":73},[[10,{"Var":10}],[11,{"Var":11}]]]},{"Var":11}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":11}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
