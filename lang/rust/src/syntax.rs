...
pub const TYPE_PARAMETERS: NodeType = NodeType(144);
pub const TYPE_PARAMETER: NodeType = NodeType(145);
pub const MOD_DEF: NodeType = NodeType(146);
pub const STRUCT_FIELD: NodeType = NodeType(147);
pub const TUPLE_FIELD: NodeType = NodeType(148);
pub const VISIBILITY: NodeType = NodeType(149);
pub const PATH: NodeType = NodeType(150);
pub const TYPE_ARGUMENTS: NodeType = NodeType(151);
pub const ALIAS: NodeType = NodeType(152);
pub const TYPE: NodeType = NodeType(153);
pub const PATTERN: NodeType = NodeType(154);
pub const EXPR: NodeType = NodeType(155);
...
pub const REFERENCE_EXPR: NodeType = NodeType(165);
pub const DEREFERENCE_EXPR: NodeType = NodeType(166);
pub const NEGATION_EXPR: NodeType = NodeType(167);
pub const PRODUCT_EXPR: NodeType = NodeType(168);
pub const SUM_EXPR: NodeType = NodeType(169);
pub const BIT_SHIFT: NodeType = NodeType(170);
pub const BIT_AND: NodeType = NodeType(171);
pub const BIT_OR: NodeType = NodeType(172);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, LPAREN, RPAREN, LBRACE, RBRACE, LANGLE, RANGLE, SHL, SHR, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, IDENT, NUMBER, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, STRUCT_DEF, TYPE_PARAMETERS, TYPE_PARAMETER, MOD_DEF, STRUCT_FIELD, TUPLE_FIELD, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PAREN_EXPR, PATH_EXPR, BLOCK_EXPR, LET_STMT, EXPR_STMT, IF_EXPR, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR,
        ];
        let parser_json = r##"[{"body":{"Pub":[37,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":7}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":8}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"Token":4}],null]},{"And":[[{"Token":10}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":11}],null]},{"And":[[{"Rule":14}],null]}]}},{"body":{"Pub":[38,{"Or":[{"And":[[{"Token":9},{"Or":[{"And":[[{"Rule":18},{"Or":[{"And":[[{"Rule":26}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":25},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":25}},{"Rule":5}],null]}]},{"Token":23}],1]}]}]}},{"body":{"Pub":[39,{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Call":[{"Rule":49},[[1,{"Call":[{"Rule":48},[[0,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[40,{"Or":[{"And":[[{"Token":35},{"Opt":{"Rule":26}}],1]}]}]}},{"body":{"Pub":[41,{"Or":[{"And":[[{"Token":4},{"Token":3},{"Token":35},{"Opt":{"Rule":26}},{"Token":23}],2]}]}]}},{"body":{"Pub":[42,{"Or":[{"And":[[{"Opt":{"Rule":17}},{"Token":5},{"Token":35},{"Opt":{"Rule":12}},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":21},{"Rule":27}],null]}]}},{"Rule":35}],2]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":50},[[2,{"Call":[{"Rule":48},[[0,{"Rule":10}]]]}]]]}],null]}]}},{"body":{"Pub":[43,{"Or":[{"And":[[{"Rule":28},{"Token":24},{"Rule":27}],null]}]}]}},{"body":{"Pub":[44,{"Or":[{"And":[[{"Opt":{"Rule":17}},{"Token":8},{"Token":35},{"Opt":{"Rule":12}},{"Or":[{"And":[[{"Call":[{"Rule":49},[[1,{"Call":[{"Rule":48},[[0,{"Rule":15}]]]}]]]}],null]},{"And":[[{"Token":23}],null]},{"And":[[{"Call":[{"Rule":50},[[2,{"Call":[{"Rule":48},[[0,{"Rule":16}]]]}]]]},{"Token":23}],null]}]}],2]}]}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Call":[{"Rule":51},[[3,{"Call":[{"Rule":48},[[0,{"Rule":13}]]]}]]]}],null]}]}]}},{"body":{"Pub":[46,{"Or":[{"And":[[{"Token":35}],null]}]}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Opt":{"Rule":17}},{"Token":10},{"Token":35},{"Or":[{"And":[[{"Token":23}],null]},{"And":[[{"Call":[{"Rule":49},[[1,{"Rule":1}]]]}],null]}]}],2]}]}]}},{"body":{"Pub":[48,{"Or":[{"And":[[{"Opt":{"Rule":17}},{"Token":35},{"Token":24},{"Rule":27}],2]}]}]}},{"body":{"Pub":[49,{"Or":[{"And":[[{"Opt":{"Rule":17}},{"Rule":27}],null]}]}]}},{"body":{"Pub":[50,{"Or":[{"And":[[{"Token":7}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":21}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":21}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":21}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[51,{"Or":[{"And":[[{"Opt":{"Token":25}},{"Rule":24}],null]}]}]}}},{"Postfix":{"ty":51,"op":{"Or":[{"And":[[{"Token":25},{"Rule":24}],null]}]}}}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Opt":{"Token":25}},{"Rule":24}],null]}]}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Rule":21},{"Or":[{"And":[[{"Token":25},{"Rule":24}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":35},{"Opt":{"Rule":25}}],null]}]}},{"body":{"Pub":[52,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":25}],null]}]},{"Call":[{"Rule":51},[[3,{"Call":[{"Rule":48},[[0,{"Rule":27}]]]}]]]}],null]}]}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":2},{"Token":35}],null]}]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"Rule":19}],null]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Token":35}],null]},{"And":[[{"Token":34}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[57,{"Or":[{"And":[[{"Token":36}],null]}]}]}}},{"Atom":{"body":{"Pub":[58,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":20},{"Call":[{"Rule":49},[[1,{"Call":[{"Rule":48},[[0,{"Rule":32}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[61,{"Or":[{"And":[[{"Rule":20}],null]}]}]}}},{"Atom":{"body":{"Pub":[60,{"Or":[{"And":[[{"Token":13},{"Exit":[4,{"Rule":29}]},{"Token":14}],null]}]}]}}},{"Atom":{"body":{"Pub":[62,{"Or":[{"And":[[{"Call":[{"Rule":49},[[1,{"Or":[{"And":[[{"Rep":{"Rule":36}},{"Opt":{"Rule":29}}],null]}]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[65,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":29}]},{"Rule":35},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":35}],null]}]}}],1]}]}]}}},{"Prefix":{"ty":66,"op":{"Token":32}}},{"Prefix":{"ty":67,"op":{"Token":27}}},{"Prefix":{"ty":68,"op":{"Token":31}}},{"Binary":{"ty":69,"op":{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},"priority":5}},{"Binary":{"ty":70,"op":{"Or":[{"And":[[{"Token":30}],null]},{"And":[[{"Token":31}],null]}]},"priority":4}},{"Binary":{"ty":71,"op":{"Or":[{"And":[[{"ContextualToken":[19,"<<"]}],null]},{"And":[[{"ContextualToken":[20,">>"]}],null]}]},"priority":3}},{"Binary":{"ty":72,"op":{"Token":32},"priority":2}},{"Binary":{"ty":73,"op":{"Token":33},"priority":1}}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Token":36}],null]}]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":20},{"Call":[{"Rule":49},[[1,{"Call":[{"Rule":48},[[0,{"Rule":32}]]]}]]]}],null]}]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Token":35},{"Token":24},{"Rule":29}],1]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Token":13},{"Exit":[4,{"Rule":29}]},{"Token":14}],null]}]}]}},{"body":{"Pub":[61,{"Or":[{"And":[[{"Rule":20}],null]}]}]}},{"body":{"Pub":[62,{"Or":[{"And":[[{"Call":[{"Rule":49},[[1,{"Or":[{"And":[[{"Rep":{"Rule":36}},{"Opt":{"Rule":29}}],null]}]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":37}],null]},{"And":[[{"Rule":38}],null]}]}},{"body":{"Pub":[63,{"Or":[{"And":[[{"Token":6},{"Rule":28},{"Token":22},{"Rule":29},{"Token":23}],1]}]}]}},{"body":{"Pub":[64,{"Or":[{"And":[[{"Rule":29},{"Token":23}],null]}]}]}},{"body":{"Pub":[65,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":29}]},{"Rule":35},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":35}],null]}]}}],1]}]}]}},{"body":{"Pub":[66,{"Or":[{"And":[[{"Token":32},{"Rule":29}],null]}]}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Token":27},{"Rule":29}],null]}]}]}},{"body":{"Pub":[68,{"Or":[{"And":[[{"Token":31},{"Rule":29}],null]}]}]}},{"body":{"Pub":[69,{"Or":[{"And":[[{"Rule":29},{"Or":[{"And":[[{"Token":27}],null]},{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},{"Rule":29}],null]}]}]}},{"body":{"Pub":[70,{"Or":[{"And":[[{"Rule":29},{"Or":[{"And":[[{"Token":30}],null]},{"And":[[{"Token":31}],null]}]},{"Rule":29}],null]}]}]}},{"body":{"Pub":[71,{"Or":[{"And":[[{"Rule":29},{"Or":[{"And":[[{"ContextualToken":[19,"<<"]}],null]},{"And":[[{"ContextualToken":[20,">>"]}],null]}]},{"Rule":29}],null]}]}]}},{"body":{"Pub":[72,{"Or":[{"And":[[{"Rule":29},{"Token":32},{"Rule":29}],null]}]}]}},{"body":{"Pub":[73,{"Or":[{"And":[[{"Rule":29},{"Token":33},{"Rule":29}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":0},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":26}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":52},[[4,{"Token":15}],[5,{"Token":16}],[6,{"Var":1}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":52},[[4,{"Token":13}],[5,{"Token":14}],[6,{"Var":2}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":52},[[4,{"Token":17}],[5,{"Token":18}],[6,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":4},{"Layer":[{"Call":[{"Rule":53},[[7,{"Var":4}],[8,{"Var":5}]]]},{"Var":6}]},{"Var":5}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":7},{"Call":[{"Rule":53},[[7,{"Var":7}],[8,{"Var":8}]]]},{"Var":8}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":8}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
