...
pub const CALL_EXPR: NodeType = NodeType(171);
pub const VALUE_ARGUMENT: NodeType = NodeType(172);
pub const REFERENCE_EXPR: NodeType = NodeType(173);
pub const DEREFERENCE_EXPR: NodeType = NodeType(174);
pub const NEGATION_EXPR: NodeType = NodeType(175);
pub const PRODUCT_EXPR: NodeType = NodeType(176);
pub const SUM_EXPR: NodeType = NodeType(177);
pub const BIT_SHIFT: NodeType = NodeType(178);
pub const BIT_AND: NodeType = NodeType(179);
pub const BIT_OR: NodeType = NodeType(180);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, UNION, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, ENUM, IMPL, LPAREN, RPAREN, LBRACE, RBRACE, LANGLE, RANGLE, SHL, SHR, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, IDENT, NUMBER, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, STRUCT_DEF, STRUCT_FIELD, TUPLE_FIELD, ENUM_DEF, ENUM_VARIANT, MOD_DEF, IMPL_DEF, TYPE_PARAMETERS, TYPE_PARAMETER, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PAREN_EXPR, PATH_EXPR, BLOCK_EXPR, LET_STMT, EXPR_STMT, IF_EXPR, CALL_EXPR, VALUE_ARGUMENT, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR,
        ];
        let parser_json = r##"[{"body":{"Pub":[40,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":6}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]},{"And":[[{"Token":14}],null]},{"And":[[{"Token":10}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":15}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":11}],null]},{"And":[[{"Rule":14}],null]},{"And":[[{"Rule":16}],null]},{"And":[[{"Rule":17}],null]}]}},{"body":{"Pub":[41,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Token":10},{"Or":[{"And":[[{"Rule":22},{"Or":[{"And":[[{"Rule":30}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":28},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":28}},{"Rule":5}],null]}]},{"Token":26}],2]}]}]}},{"body":{"Pub":[42,{"Or":[{"And":[[{"Token":30}],null]},{"And":[[{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[43,{"Or":[{"And":[[{"Token":38},{"Opt":{"Rule":30}}],1]}]}]}},{"body":{"Pub":[44,{"Or":[{"And":[[{"Token":5},{"Token":4},{"Token":38},{"Opt":{"Rule":30}},{"Token":26}],2]}]}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Token":6},{"Token":38},{"Opt":{"Rule":19}},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":24},{"Rule":31}],null]}]}},{"Rule":39}],2]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":56},[[2,{"Call":[{"Rule":54},[[0,{"Rule":10}]]]}]]]}],null]}]}},{"body":{"Pub":[46,{"Or":[{"And":[[{"Rule":32},{"Token":27},{"Rule":31}],null]}]}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Or":[{"And":[[{"Token":9}],null]},{"And":[[{"ContextualToken":[2,"union"]}],null]}]},{"Token":38},{"Opt":{"Rule":19}},{"Or":[{"And":[[{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":12}]]]}]]]}],null]},{"And":[[{"Token":26}],null]},{"And":[[{"Call":[{"Rule":56},[[2,{"Call":[{"Rule":54},[[0,{"Rule":13}]]]}]]]},{"Token":26}],null]}]}],2]}]}]}},{"body":{"Pub":[48,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Token":38},{"Token":27},{"Rule":31}],2]}]}]}},{"body":{"Pub":[49,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Rule":31}],null]}]}]}},{"body":{"Pub":[50,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Token":14},{"Token":38},{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":15}]]]}]]]}],2]}]}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Token":38},{"Opt":{"Or":[{"And":[[{"Token":25},{"Rule":33}],null]},{"And":[[{"Call":[{"Rule":56},[[2,{"Call":[{"Rule":54},[[0,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":12}]]]}]]]}],null]}]}}],1]}]}]}},{"body":{"Pub":[52,{"Or":[{"And":[[{"Opt":{"Rule":21}},{"Token":11},{"Token":38},{"Or":[{"And":[[{"Token":26}],null]},{"And":[[{"Call":[{"Rule":55},[[1,{"Rule":1}]]]}],null]}]}],2]}]}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":15},{"Token":38},{"Call":[{"Rule":55},[[1,{"Rep":{"Rule":18}}]]]}],1]}]}]}},{"body":{"Or":[{"And":[[{"Rule":8}],null]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"Call":[{"Rule":57},[[3,{"Call":[{"Rule":54},[[0,{"Rule":20}]]]}]]]}],null]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Token":38}],null]}]}]}},{"body":{"Pub":[56,{"Or":[{"And":[[{"Token":8}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":25}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":25}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":25}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[57,{"Or":[{"And":[[{"Opt":{"Token":28}},{"Rule":28}],null]}]}]}}},{"Postfix":{"ty":57,"op":{"Or":[{"And":[[{"Token":28},{"Rule":28}],null]}]}}}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Opt":{"Token":28}},{"Rule":28}],null]}]}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Rule":25},{"Or":[{"And":[[{"Token":28},{"Rule":28}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":38},{"Opt":{"Rule":29}}],null]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":28}],null]}]},{"Call":[{"Rule":57},[[3,{"Call":[{"Rule":54},[[0,{"Rule":31}]]]}]]]}],null]}]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Token":3},{"Token":38}],null]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Rule":23}],null]}]}]}},{"body":{"Pub":[61,{"Or":[{"And":[[{"Token":38}],null]},{"And":[[{"Token":37}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[63,{"Or":[{"And":[[{"Token":39}],null]}]}]}}},{"Atom":{"body":{"Pub":[64,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":24},{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":36}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[67,{"Or":[{"And":[[{"Rule":24}],null]}]}]}}},{"Atom":{"body":{"Pub":[66,{"Or":[{"And":[[{"Token":16},{"Exit":[4,{"Rule":33}]},{"Token":17}],null]}]}]}}},{"Atom":{"body":{"Pub":[68,{"Or":[{"And":[[{"Exit":[4,{"Call":[{"Rule":55},[[1,{"Or":[{"And":[[{"Rep":{"Rule":40}},{"Opt":{"Rule":33}}],null]}]}]]]}]}],null]}]}]}}},{"Atom":{"body":{"Pub":[71,{"Or":[{"And":[[{"Token":12},{"Enter":[4,{"Rule":33}]},{"Rule":39},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":39}],null]}]}}],1]}]}]}}},{"Postfix":{"ty":72,"op":{"Exit":[4,{"Call":[{"Rule":56},[[2,{"Call":[{"Rule":54},[[0,{"Rule":45}]]]}]]]}]}}},{"Prefix":{"ty":74,"op":{"Token":35}}},{"Prefix":{"ty":75,"op":{"Token":30}}},{"Prefix":{"ty":76,"op":{"Token":34}}},{"Binary":{"ty":77,"op":{"Or":[{"And":[[{"Token":30}],null]},{"And":[[{"Token":31}],null]},{"And":[[{"Token":32}],null]}]},"priority":5}},{"Binary":{"ty":78,"op":{"Or":[{"And":[[{"Token":33}],null]},{"And":[[{"Token":34}],null]}]},"priority":4}},{"Binary":{"ty":79,"op":{"Or":[{"And":[[{"ContextualToken":[22,"<<"]}],null]},{"And":[[{"ContextualToken":[23,">>"]}],null]}]},"priority":3}},{"Binary":{"ty":80,"op":{"Token":35},"priority":2}},{"Binary":{"ty":81,"op":{"Token":36},"priority":1}}]}},{"body":{"Pub":[63,{"Or":[{"And":[[{"Token":39}],null]}]}]}},{"body":{"Pub":[64,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":24},{"Call":[{"Rule":55},[[1,{"Call":[{"Rule":54},[[0,{"Rule":36}]]]}]]]}],null]}]}]}},{"body":{"Pub":[65,{"Or":[{"And":[[{"Token":38},{"Token":27},{"Rule":33}],1]}]}]}},{"body":{"Pub":[66,{"Or":[{"And":[[{"Token":16},{"Exit":[4,{"Rule":33}]},{"Token":17}],null]}]}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Rule":24}],null]}]}]}},{"body":{"Pub":[68,{"Or":[{"And":[[{"Exit":[4,{"Call":[{"Rule":55},[[1,{"Or":[{"And":[[{"Rep":{"Rule":40}},{"Opt":{"Rule":33}}],null]}]}]]]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":41}],null]},{"And":[[{"Rule":42}],null]}]}},{"body":{"Pub":[69,{"Or":[{"And":[[{"Token":7},{"Rule":32},{"Token":25},{"Rule":33},{"Token":26}],1]}]}]}},{"body":{"Pub":[70,{"Or":[{"And":[[{"Rule":33},{"Token":26}],null]}]}]}},{"body":{"Pub":[71,{"Or":[{"And":[[{"Token":12},{"Enter":[4,{"Rule":33}]},{"Rule":39},{"Opt":{"Or":[{"And":[[{"Token":13},{"Rule":39}],null]}]}}],1]}]}]}},{"body":{"Pub":[72,{"Or":[{"And":[[{"Rule":33},{"Exit":[4,{"Call":[{"Rule":56},[[2,{"Call":[{"Rule":54},[[0,{"Rule":45}]]]}]]]}]}],null]}]}]}},{"body":{"Pub":[73,{"Or":[{"And":[[{"Rule":33}],null]}]}]}},{"body":{"Pub":[74,{"Or":[{"And":[[{"Token":35},{"Rule":33}],null]}]}]}},{"body":{"Pub":[75,{"Or":[{"And":[[{"Token":30},{"Rule":33}],null]}]}]}},{"body":{"Pub":[76,{"Or":[{"And":[[{"Token":34},{"Rule":33}],null]}]}]}},{"body":{"Pub":[77,{"Or":[{"And":[[{"Rule":33},{"Or":[{"And":[[{"Token":30}],null]},{"And":[[{"Token":31}],null]},{"And":[[{"Token":32}],null]}]},{"Rule":33}],null]}]}]}},{"body":{"Pub":[78,{"Or":[{"And":[[{"Rule":33},{"Or":[{"And":[[{"Token":33}],null]},{"And":[[{"Token":34}],null]}]},{"Rule":33}],null]}]}]}},{"body":{"Pub":[79,{"Or":[{"And":[[{"Rule":33},{"Or":[{"And":[[{"ContextualToken":[22,"<<"]}],null]},{"And":[[{"ContextualToken":[23,">>"]}],null]}]},{"Rule":33}],null]}]}]}},{"body":{"Pub":[80,{"Or":[{"And":[[{"Rule":33},{"Token":35},{"Rule":33}],null]}]}]}},{"body":{"Pub":[81,{"Or":[{"And":[[{"Rule":33},{"Token":36},{"Rule":33}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":0},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":29}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":58},[[4,{"Token":18}],[5,{"Token":19}],[6,{"Var":1}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":58},[[4,{"Token":16}],[5,{"Token":17}],[6,{"Var":2}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":58},[[4,{"Token":20}],[5,{"Token":21}],[6,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":4},{"Layer":[{"Call":[{"Rule":59},[[7,{"Var":4}],[8,{"Var":5}]]]},{"Var":6}]},{"Var":5}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":7},{"Call":[{"Rule":59},[[7,{"Var":7}],[8,{"Var":8}]]]},{"Var":8}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":8}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
