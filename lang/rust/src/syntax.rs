...
pub const REFERENCE_EXPR: NodeType = NodeType(161);
pub const DEREFERENCE_EXPR: NodeType = NodeType(162);
pub const NEGATION_EXPR: NodeType = NodeType(163);
pub const PRODUCT_EXPR: NodeType = NodeType(164);
pub const SUM_EXPR: NodeType = NodeType(165);
pub const BIT_AND: NodeType = NodeType(166);
pub const BIT_OR: NodeType = NodeType(167);
...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        const ALL_NODE_TYPES: &[NodeType] = &[
            ERROR,
            WHITESPACE, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, LPAREN, RPAREN, LBRACE, RBRACE, LANGLE, RANGLE, THIN_ARROW, EQ, SEMI, COLON, COLONCOLON, COMMA, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, IDENT, NUMBER, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, VALUE_PARAM, STRUCT_DEF, MOD_DEF, STRUCT_FIELD, TUPLE_FIELD, VISIBILITY, PATH, TYPE_ARGUMENTS, ALIAS, TYPE, PATTERN, EXPR, LITERAL, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, PAREN_EXPR, PATH_EXPR, BLOCK_EXPR, LET_STMT, EXPR_STMT, IF_EXPR, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_AND, BIT_OR,
        ];
        let parser_json = r##"[{"body":{"Pub":[35,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":7}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":8}],null]},{"And":[[{"Token":9}],null]},{"And":[[{"Token":4}],null]},{"And":[[{"Token":10}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":11}],null]},{"And":[[{"Rule":12}],null]}]}},{"body":{"Pub":[36,{"Or":[{"And":[[{"Token":9},{"Or":[{"And":[[{"Rule":16},{"Or":[{"And":[[{"Rule":24}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":23},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":23}},{"Rule":5}],null]}]},{"Token":21}],1]}]}]}},{"body":{"Pub":[37,{"Or":[{"And":[[{"Token":25}],null]},{"And":[[{"Call":[{"Rule":46},[[1,{"Call":[{"Rule":45},[[0,{"Rule":6}]]]}]]]}],null]}]}]}},{"body":{"Pub":[38,{"Or":[{"And":[[{"Token":33},{"Opt":{"Rule":24}}],1]}]}]}},{"body":{"Pub":[39,{"Or":[{"And":[[{"Token":4},{"Token":3},{"Token":33},{"Opt":{"Rule":24}},{"Token":21}],2]}]}]}},{"body":{"Pub":[40,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":5},{"Token":33},{"Rule":9},{"Opt":{"Or":[{"And":[[{"Token":19},{"Rule":25}],null]}]}},{"Rule":33}],2]}]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":47},[[2,{"Call":[{"Rule":45},[[0,{"Rule":10}]]]}]]]}],null]}]}},{"body":{"Pub":[41,{"Or":[{"And":[[{"Rule":26},{"Token":22},{"Rule":25}],null]}]}]}},{"body":{"Pub":[42,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":8},{"Token":33},{"Or":[{"And":[[{"Call":[{"Rule":46},[[1,{"Call":[{"Rule":45},[[0,{"Rule":13}]]]}]]]}],null]},{"And":[[{"Token":21}],null]},{"And":[[{"Call":[{"Rule":47},[[2,{"Call":[{"Rule":45},[[0,{"Rule":14}]]]}]]]},{"Token":21}],null]}]}],2]}]}]}},{"body":{"Pub":[43,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":10},{"Token":33},{"Or":[{"And":[[{"Token":21}],null]},{"And":[[{"Call":[{"Rule":46},[[1,{"Rule":1}]]]}],null]}]}],2]}]}]}},{"body":{"Pub":[44,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Token":33},{"Token":22},{"Rule":25}],2]}]}]}},{"body":{"Pub":[45,{"Or":[{"And":[[{"Opt":{"Rule":15}},{"Rule":25}],null]}]}]}},{"body":{"Pub":[46,{"Or":[{"And":[[{"Token":7}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":19}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":19}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":19}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[47,{"Or":[{"And":[[{"Opt":{"Token":23}},{"Rule":22}],null]}]}]}}},{"Postfix":{"ty":47,"op":{"Or":[{"And":[[{"Token":23},{"Rule":22}],null]}]}}}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Opt":{"Token":23}},{"Rule":22}],null]}]}]}},{"body":{"Pub":[47,{"Or":[{"And":[[{"Rule":19},{"Or":[{"And":[[{"Token":23},{"Rule":22}],null]}]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":33},{"Opt":{"Rule":23}}],null]}]}},{"body":{"Pub":[48,{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":23}],null]}]},{"Call":[{"Rule":48},[[3,{"Call":[{"Rule":45},[[0,{"Rule":25}]]]}]]]}],null]}]}]}},{"body":{"Pub":[49,{"Or":[{"And":[[{"Token":2},{"Token":33}],null]}]}]}},{"body":{"Pub":[50,{"Or":[{"And":[[{"Rule":17}],null]}]}]}},{"body":{"Pub":[51,{"Or":[{"And":[[{"Token":33}],null]},{"And":[[{"Token":32}],null]}]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":34}],null]}]}]}}},{"Atom":{"body":{"Pub":[54,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":18},{"Call":[{"Rule":46},[[1,{"Call":[{"Rule":45},[[0,{"Rule":30}]]]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[57,{"Or":[{"And":[[{"Rule":18}],null]}]}]}}},{"Atom":{"body":{"Pub":[56,{"Or":[{"And":[[{"Token":13},{"Exit":[4,{"Rule":27}]},{"Token":14}],null]}]}]}}},{"Atom":{"body":{"Pub":[58,{"Or":[{"And":[[{"Call":[{"Rule":46},[[1,{"Or":[{"And":[[{"Rep":{"Rule":34}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}}},{"Atom":{"body":{"Pub":[61,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":27}]},{"Rule":33},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":33}],null]}]}}],1]}]}]}}},{"Prefix":{"ty":62,"op":{"Token":30}}},{"Prefix":{"ty":63,"op":{"Token":25}}},{"Prefix":{"ty":64,"op":{"Token":29}}},{"Binary":{"ty":66,"op":{"Or":[{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},"priority":3}},{"Binary":{"ty":65,"op":{"Or":[{"And":[[{"Token":25}],null]},{"And":[[{"Token":26}],null]},{"And":[[{"Token":27}],null]}]},"priority":4}},{"Binary":{"ty":67,"op":{"Token":30},"priority":2}},{"Binary":{"ty":68,"op":{"Token":31},"priority":1}}]}},{"body":{"Pub":[53,{"Or":[{"And":[[{"Token":34}],null]}]}]}},{"body":{"Pub":[54,{"Or":[{"And":[[{"Not":{"IsIn":4}},{"Rule":18},{"Call":[{"Rule":46},[[1,{"Call":[{"Rule":45},[[0,{"Rule":30}]]]}]]]}],null]}]}]}},{"body":{"Pub":[55,{"Or":[{"And":[[{"Token":33},{"Token":22},{"Rule":27}],1]}]}]}},{"body":{"Pub":[56,{"Or":[{"And":[[{"Token":13},{"Exit":[4,{"Rule":27}]},{"Token":14}],null]}]}]}},{"body":{"Pub":[57,{"Or":[{"And":[[{"Rule":18}],null]}]}]}},{"body":{"Pub":[58,{"Or":[{"And":[[{"Call":[{"Rule":46},[[1,{"Or":[{"And":[[{"Rep":{"Rule":34}},{"Opt":{"Rule":27}}],null]}]}]]]}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rule":35}],null]},{"And":[[{"Rule":36}],null]}]}},{"body":{"Pub":[59,{"Or":[{"And":[[{"Token":6},{"Rule":26},{"Token":20},{"Rule":27},{"Token":21}],1]}]}]}},{"body":{"Pub":[60,{"Or":[{"And":[[{"Rule":27},{"Token":21}],null]}]}]}},{"body":{"Pub":[61,{"Or":[{"And":[[{"Token":11},{"Enter":[4,{"Rule":27}]},{"Rule":33},{"Opt":{"Or":[{"And":[[{"Token":12},{"Rule":33}],null]}]}}],1]}]}]}},{"body":{"Pub":[62,{"Or":[{"And":[[{"Token":30},{"Rule":27}],null]}]}]}},{"body":{"Pub":[63,{"Or":[{"And":[[{"Token":25},{"Rule":27}],null]}]}]}},{"body":{"Pub":[64,{"Or":[{"And":[[{"Token":29},{"Rule":27}],null]}]}]}},{"body":{"Pub":[65,{"Or":[{"And":[[{"Rule":27},{"Or":[{"And":[[{"Token":25}],null]},{"And":[[{"Token":26}],null]},{"And":[[{"Token":27}],null]}]},{"Rule":27}],null]}]}]}},{"body":{"Pub":[66,{"Or":[{"And":[[{"Rule":27},{"Or":[{"And":[[{"Token":28}],null]},{"And":[[{"Token":29}],null]}]},{"Rule":27}],null]}]}]}},{"body":{"Pub":[67,{"Or":[{"And":[[{"Rule":27},{"Token":30},{"Rule":27}],null]}]}]}},{"body":{"Pub":[68,{"Or":[{"And":[[{"Rule":27},{"Token":31},{"Rule":27}],null]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":0},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":24}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":49},[[4,{"Token":15}],[5,{"Token":16}],[6,{"Var":1}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":49},[[4,{"Token":13}],[5,{"Token":14}],[6,{"Var":2}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":49},[[4,{"Token":17}],[5,{"Token":18}],[6,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":4},{"Layer":[{"Call":[{"Rule":50},[[7,{"Var":4}],[8,{"Var":5}]]]},{"Var":6}]},{"Var":5}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":7},{"Call":[{"Rule":50},[[7,{"Var":7}],[8,{"Var":8}]]]},{"Var":8}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":8}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;
