...
pub const ALIAS: NodeType = NodeType(208);
pub const PATH_TYPE: NodeType = NodeType(209);
pub const REFERENCE_TYPE: NodeType = NodeType(210);
pub const PLACEHOLDER_TYPE: NodeType = NodeType(211);
pub const UNIT_TYPE: NodeType = NodeType(212);
pub const PAREN_TYPE: NodeType = NodeType(213);
pub const TUPLE_TYPE: NodeType = NodeType(214);
pub const ARRAY_TYPE: NodeType = NodeType(215);
pub const FN_POINTER_TYPE: NodeType = NodeType(216);
pub const WILDCARD_PATTERN: NodeType = NodeType(217);
pub const PATH_PATTERN: NodeType = NodeType(218);
pub const TUPE_STRUCT_PATTERN: NodeType = NodeType(219);
pub const STRUCT_PATTERN: NodeType = NodeType(220);
pub const STRUCT_PATTERN_FIELD: NodeType = NodeType(221);
pub const BINDING_PATTERN: NodeType = NodeType(222);
pub const LITERAL_PATTERN: NodeType = NodeType(223);
pub const UNIT_PATTERN: NodeType = NodeType(224);
pub const PAREN_PATTERN: NodeType = NodeType(225);
pub const TUPLE_PATTERN: NodeType = NodeType(226);
pub const REFERENCE_PATTERN: NodeType = NodeType(227);
pub const EXPR: NodeType = NodeType(228);
pub const LITERAL: NodeType = NodeType(229);
pub const PATH_EXPR: NodeType = NodeType(230);
pub const STRUCT_LITERAL: NodeType = NodeType(231);
pub const STRUCT_LITERAL_FIELD: NodeType = NodeType(232);
pub const UNIT_EXPR: NodeType = NodeType(233);
pub const PAREN_EXPR: NodeType = NodeType(234);
pub const TUPLE_EXPR: NodeType = NodeType(235);
pub const ARRAY_LITERAL: NodeType = NodeType(236);
pub const LAMBDA_EXPR: NodeType = NodeType(237);
pub const RETURN_EXPR: NodeType = NodeType(238);
pub const BLOCK_EXPR: NodeType = NodeType(239);
pub const LET_STMT: NodeType = NodeType(240);
pub const EMPTY_STMT: NodeType = NodeType(241);
pub const EXPR_STMT: NodeType = NodeType(242);
pub const IF_EXPR: NodeType = NodeType(243);
pub const WHILE_EXPR: NodeType = NodeType(244);
pub const LOOP_EXPR: NodeType = NodeType(245);
pub const FOR_EXPR: NodeType = NodeType(246);
pub const MATCH_EXPR: NodeType = NodeType(247);
pub const MATCH_ARM: NodeType = NodeType(248);
pub const GUARD: NodeType = NodeType(249);
pub const BLOCK_MACRO_EXPR: NodeType = NodeType(250);
pub const LINE_MACRO_EXPR: NodeType = NodeType(251);
pub const METHOD_CALL_EXPR: NodeType = NodeType(252);
pub const CALL_EXPR: NodeType = NodeType(253);
pub const FIELD_EXPR: NodeType = NodeType(254);
pub const INDEX_EXPR: NodeType = NodeType(255);
pub const VALUE_ARGUMENT: NodeType = NodeType(256);
pub const REFERENCE_EXPR: NodeType = NodeType(257);
pub const DEREFERENCE_EXPR: NodeType = NodeType(258);
pub const NEGATION_EXPR: NodeType = NodeType(259);
pub const NOT_EXPR: NodeType = NodeType(260);
pub const PRODUCT_EXPR: NodeType = NodeType(261);
pub const SUM_EXPR: NodeType = NodeType(262);
pub const BIT_SHIFT: NodeType = NodeType(263);
pub const BIT_AND: NodeType = NodeType(264);
pub const BIT_OR: NodeType = NodeType(265);
pub const COMPARISON: NodeType = NodeType(266);
pub const LOGICAL_AND: NodeType = NodeType(267);
pub const LOGICAL_OR: NodeType = NodeType(268);
pub const RANGE_EXPR: NodeType = NodeType(269);
pub const ASSIGNMENT_EXPR: NodeType = NodeType(270);
pub const ATTRIBUTE: NodeType = NodeType(271);
pub const ATTR_VALUE: NodeType = NodeType(272);
pub const BLOCK_MACRO: NodeType = NodeType(273);
pub const LINE_MACRO: NodeType = NodeType(274);
pub const TT: NodeType = NodeType(275);


fn create_parser_definition() -> ::fall_parse::ParserDefinition {
    use fall_parse::LexRule;
    let parser_json = r##"[{"body":{"Pub":{"ty_idx":78,"body":{"Or":[{"And":[[{"Rule":1}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"WithSkip":[{"Rule":2},{"Rule":3}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":11}],null]},{"And":[[{"ContextualToken":[4,"union"]}],null]},{"And":[[{"Token":16}],null]},{"And":[[{"Token":12}],null]},{"And":[[{"Token":13}],null]},{"And":[[{"Token":17}],null]},{"And":[[{"Token":29}],null]},{"And":[[{"Rule":25}],null]}]}},{"body":{"Or":[{"And":[[{"Rule":24}],null]},{"And":[[{"Rule":4}],null]},{"And":[[{"Rule":7}],null]},{"And":[[{"Rule":15}],null]},{"And":[[{"Rule":18}],null]},{"And":[[{"Rule":20}],null]},{"And":[[{"Rule":21}],null]},{"And":[[{"Rule":22}],null]},{"And":[[{"Rule":29}],null]}]}},{"body":{"Pub":{"ty_idx":79,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":12},{"Or":[{"And":[[{"Rule":38},{"Or":[{"And":[[{"Rule":46}],null]},{"And":[[{"Opt":{"Or":[{"And":[[{"Token":56},{"Rule":5}],null]}]}}],null]}]}],null]},{"And":[[{"Opt":{"Token":56}},{"Rule":5}],null]}]},{"Token":54}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":80,"body":{"Or":[{"And":[[{"Token":63}],null]},{"And":[[{"Call":[{"Rule":132},[[3,{"Call":[{"Rule":131},[[2,{"Rule":6}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":81,"body":{"Or":[{"And":[[{"Token":18}],null]},{"And":[[{"Token":74},{"Opt":{"Rule":46}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":82,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":7},{"Token":6},{"Token":74},{"Opt":{"Rule":46}},{"Token":54}],4]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":83,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Opt":{"Rule":10}},{"Token":8},{"Token":74},{"Opt":{"Rule":31}},{"Rule":11},{"Opt":{"Rule":9}},{"Opt":{"Rule":37}},{"Or":[{"And":[[{"Rule":83}],null]},{"And":[[{"Token":54}],null]}]}],4]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Token":47},{"Rule":47}],null]}]}},{"body":{"Pub":{"ty_idx":84,"body":{"Or":[{"And":[[{"Token":7},{"Opt":{"Token":76}}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Opt":{"Rule":14}},{"Call":[{"Rule":131},[[2,{"Rule":12}]]]}],null]}]}]]]}],null]}]}},{"body":{"Pub":{"ty_idx":85,"body":{"Or":[{"And":[[{"Rule":57},{"Token":55},{"Rule":47}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":86,"body":{"Or":[{"And":[[{"Rule":57},{"Opt":{"Or":[{"And":[[{"Token":55},{"Rule":47}],null]}]}}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":87,"body":{"Or":[{"And":[[{"Opt":{"Token":68}},{"Opt":{"Token":27}},{"Token":18},{"Opt":{"Or":[{"And":[[{"Token":55},{"Rule":47}],null]}]}},{"Or":[{"And":[[{"Token":57}],null]},{"And":[["Eof"],null]}]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":88,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Or":[{"And":[[{"Token":11}],null]},{"And":[[{"ContextualToken":[4,"union"]}],null]}]},{"Token":74},{"Opt":{"Rule":31}},{"Or":[{"And":[[{"Call":[{"Rule":132},[[3,{"Call":[{"Rule":131},[[2,{"Rule":16}]]]}]]]}],null]},{"And":[[{"Token":54}],null]},{"And":[[{"Call":[{"Rule":133},[[4,{"Call":[{"Rule":131},[[2,{"Rule":17}]]]}]]]},{"Token":54}],null]}]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":89,"body":{"Or":[{"And":[[{"Opt":{"Rule":36}},{"Token":74},{"Token":55},{"Rule":47}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":90,"body":{"Or":[{"And":[[{"Opt":{"Rule":36}},{"Rule":47}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":91,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":16},{"Token":74},{"Call":[{"Rule":132},[[3,{"Call":[{"Rule":131},[[2,{"Rule":19}]]]}]]]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":92,"body":{"Or":[{"And":[[{"Token":74},{"Opt":{"Or":[{"And":[[{"Token":49},{"Rule":69}],null]},{"And":[[{"Call":[{"Rule":133},[[4,{"Call":[{"Rule":131},[[2,{"Rule":17}]]]}]]]}],null]},{"And":[[{"Call":[{"Rule":132},[[3,{"Call":[{"Rule":131},[[2,{"Rule":16}]]]}]]]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":93,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":13},{"Token":74},{"Or":[{"And":[[{"Token":54}],null]},{"And":[[{"Call":[{"Rule":132},[[3,{"Rule":1}]]]}],null]}]}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":94,"body":{"Or":[{"And":[[{"Rule":126},{"Token":17},{"Opt":{"Rule":31}},{"Or":[{"And":[[{"Rule":47},{"Opt":{"Or":[{"And":[[{"Token":23},{"Rule":47}],null]}]}}],null]}]},{"Rule":23}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":95,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":29},{"Token":74},{"Opt":{"Rule":31}},{"Rule":23}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":96,"body":{"Or":[{"And":[[{"Call":[{"Rule":132},[[3,{"Rep":{"WithSkip":[{"Rule":25},{"Rule":24}]}}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":26}],null]},{"And":[[{"Rule":27}],null]},{"And":[[{"Rule":28}],null]}]}},{"body":{"Or":[{"And":[[{"Token":10}],null]},{"And":[[{"Token":8}],null]},{"And":[[{"Token":20}],null]},{"And":[[{"Token":21}],null]},{"And":[[{"Token":22}],null]},{"And":[[{"Token":61}],null]},{"And":[[{"Token":7}],null]},{"And":[[{"Or":[{"And":[[{"Token":74},{"Token":71}],null]}]}],null]}]}},{"body":{"Pub":{"ty_idx":97,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Token":20},{"Token":74},{"Opt":{"Rule":31}},{"Opt":{"Or":[{"And":[[{"Token":49},{"Rule":47}],null]}]}},{"Token":54}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":98,"body":{"Or":[{"And":[[{"Rule":126},{"Opt":{"Rule":36}},{"Or":[{"And":[[{"Token":21}],null]},{"And":[[{"Token":22}],null]}]},{"Token":74},{"Token":55},{"Rule":47},{"Opt":{"Or":[{"And":[[{"Token":49},{"Rule":69}],null]}]}},{"Token":54}],3]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":99,"body":{"Or":[{"And":[[{"Rule":128}],null]},{"And":[[{"Rule":129},{"Token":54}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":100,"body":{"Or":[{"And":[[{"Rule":10},{"Call":[{"Rule":132},[[3,{"Rep":{"Rule":30}}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":8}],null]},{"And":[[{"Rule":27}],null]}]}},{"body":{"Pub":{"ty_idx":101,"body":{"Or":[{"And":[[{"Call":[{"Rule":134},[[5,{"Or":[{"And":[[{"Call":[{"Rule":131},[[2,{"Rule":35}]]]},{"Call":[{"Rule":131},[[2,{"Rule":32}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":102,"body":{"Or":[{"And":[[{"Token":74},{"Opt":{"Rule":33}}],1]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Token":55},{"Rep":{"Or":[{"And":[[{"Rule":34},{"Or":[{"And":[[{"Token":66}],null]},{"And":[["Eof"],null]},{"And":[[{"Not":{"Not":{"Token":57}}}],null]},{"And":[[{"Not":{"Not":{"Token":37}}}],null]}]}],1]}]}}],null]}]}},{"body":{"Pub":{"ty_idx":103,"body":{"Or":[{"And":[[{"Token":73}],null]},{"And":[[{"Rule":47}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":104,"body":{"Or":[{"And":[[{"Token":73},{"Opt":{"Or":[{"And":[[{"Token":55},{"Rep":{"Or":[{"And":[[{"Token":73},{"Or":[{"And":[[{"Token":66}],null]},{"And":[["Eof"],null]},{"And":[[{"Not":{"Not":{"Token":57}}}],null]}]}],1]}]}}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":105,"body":{"Or":[{"And":[[{"Token":10}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":106,"body":{"Or":[{"And":[[{"Token":34},{"Rep":{"Or":[{"And":[[{"Rule":47},{"Rule":33},{"Or":[{"And":[[{"Token":57}],null]},{"And":[["Eof"],null]},{"And":[[{"Not":{"Not":{"Token":37}}}],null]}]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":41}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[0,{"Rule":41}]}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[1,{"Rule":41}]}],null]}]}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":{"ty_idx":107,"body":{"Or":[{"And":[[{"Opt":{"Token":56}},{"Rule":44}],null]}]},"replaceable":false}}}},{"Postfix":{"ty":107,"op":{"Or":[{"And":[[{"Token":56},{"Rule":44}],null]}]}}}]}},{"body":{"Pub":{"ty_idx":107,"body":{"Or":[{"And":[[{"Opt":{"Token":56}},{"Rule":44}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":107,"body":{"Or":[{"And":[[{"Rule":41},{"Or":[{"And":[[{"Token":56},{"Rule":44}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":74}],null]},{"And":[[{"Token":18}],null]},{"And":[[{"Token":19}],null]}]},{"Opt":{"Rule":45}}],null]}]}},{"body":{"Pub":{"ty_idx":108,"body":{"Or":[{"And":[[{"Or":[{"And":[[{"IsIn":0}],null]},{"And":[[{"IsIn":1},{"Token":56}],null]}]},{"Call":[{"Rule":134},[[5,{"Or":[{"And":[[{"Call":[{"Rule":131},[[2,{"Token":73}]]]},{"Call":[{"Rule":131},[[2,{"Rule":47}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":109,"body":{"Or":[{"And":[[{"Token":5},{"Token":74}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":48}],null]},{"And":[[{"Rule":49}],null]},{"And":[[{"Rule":50}],null]},{"And":[[{"Rule":51}],null]},{"And":[[{"Rule":52}],null]},{"And":[[{"Rule":54}],null]},{"And":[[{"Rule":55}],null]}]}},{"body":{"Pub":{"ty_idx":110,"body":{"Or":[{"And":[[{"Rule":39}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":111,"body":{"Or":[{"And":[[{"Token":68},{"Opt":{"Token":73}},{"Opt":{"Token":27}},{"Rule":47}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":112,"body":{"Or":[{"And":[[{"Token":70}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":113,"body":{"Or":[{"And":[[{"Token":35},{"Token":36}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":114,"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Rule":47},{"Opt":{"Rule":53}}],null]}]}]]]}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":115,"body":{"Or":[{"And":[[{"Token":57},{"Call":[{"Rule":131},[[2,{"Rule":47}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":116,"body":{"Or":[{"And":[[{"Call":[{"Rule":135},[[6,{"Or":[{"And":[[{"Rule":47},{"Opt":{"Or":[{"And":[[{"Token":54},{"Rule":69}],null]}]}}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":117,"body":{"Or":[{"And":[[{"Token":8},{"Call":[{"Rule":133},[[4,{"Call":[{"Rule":131},[[2,{"Rule":56}]]]}]]]},{"Rule":9}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":85,"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Rule":57},{"Token":55}],null]}]}},{"Rule":47}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":58}],null]},{"And":[[{"Rule":59}],null]},{"And":[[{"Rule":63}],null]},{"And":[[{"Rule":64}],null]},{"And":[[{"Rule":65}],null]},{"And":[[{"Rule":66}],null]},{"And":[[{"Rule":68}],null]}]}},{"body":{"Pub":{"ty_idx":118,"body":{"Or":[{"And":[[{"Token":70}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":119,"body":{"Or":[{"And":[[{"Rule":40},{"Opt":{"Or":[{"And":[[{"Rule":60}],null]},{"And":[[{"Rule":61}],null]}]}}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":120,"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Call":[{"Rule":131},[[2,{"Rule":57}]]]},{"Opt":{"Or":[{"And":[[{"Token":59},{"Opt":{"Token":57}}],null]}]}}],null]}]}]]]}],null]}]}}}},{"body":{"PubReplace":{"ty_idx":121,"body":{"Or":[{"And":[[{"Call":[{"Rule":132},[[3,{"Or":[{"And":[[{"Call":[{"Rule":131},[[2,{"Rule":62}]]]},{"Opt":{"Or":[{"And":[[{"Token":59},{"Opt":{"Token":57}}],null]}]}}],null]}]}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":122,"body":{"Or":[{"And":[[{"Rule":63},{"Not":{"Token":55}}],null]},{"And":[[{"Token":74},{"Token":55},{"Rule":57}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":123,"body":{"Or":[{"And":[[{"Opt":{"Token":28}},{"Opt":{"Token":27}},{"Token":74}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":124,"body":{"Or":[{"And":[[{"Rule":72}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":125,"body":{"Or":[{"And":[[{"Token":35},{"Token":36}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":126,"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Rule":57},{"Opt":{"Rule":67}}],null]}]}]]]}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":127,"body":{"Or":[{"And":[[{"Token":57},{"Call":[{"Rule":131},[[2,{"Rule":57}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":128,"body":{"Or":[{"And":[[{"Token":68},{"Opt":{"Token":27}},{"Rule":57}],null]}]},"replaceable":false}}},{"body":{"Pratt":[{"Atom":{"body":{"Pub":{"ty_idx":130,"body":{"Or":[{"And":[[{"Token":75}],null]},{"And":[[{"Token":76}],null]},{"And":[[{"Token":77}],null]},{"And":[[{"Token":72}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":131,"body":{"Or":[{"And":[[{"Not":{"Or":[{"And":[[{"Token":74},{"Token":71}],null]}]}},{"Rule":40},{"Opt":{"Rule":74}}],null]}]},"replaceable":true}}}},{"Atom":{"body":{"Pub":{"ty_idx":134,"body":{"Or":[{"And":[[{"Token":35},{"Token":36}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":135,"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Call":[{"Rule":71},[[0,{"Rule":69}]]]},{"Opt":{"Rule":78}}],null]}]}]]]}],null]}]},"replaceable":true}}}},{"Atom":{"body":{"Pub":{"ty_idx":137,"body":{"Or":[{"And":[[{"Call":[{"Rule":135},[[6,{"Call":[{"Rule":71},[[0,{"Call":[{"Rule":131},[[2,{"Rule":69}]]]}]]]}]]]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":138,"body":{"Or":[{"And":[[{"Opt":{"Token":26}},{"Token":69},{"Rep":{"Rule":81}},{"Token":69},{"Or":[{"And":[[{"Token":47},{"Rule":47},{"Rule":83}],null]},{"And":[[{"Call":[{"Rule":71},[[0,{"Rule":69}]]]}],null]}]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":139,"body":{"Or":[{"And":[[{"Token":31},{"Opt":{"Rule":69}}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":140,"body":{"Or":[{"And":[[{"Call":[{"Rule":71},[[0,{"Or":[{"And":[[{"Opt":{"Token":33}},{"Call":[{"Rule":132},[[3,{"Or":[{"And":[[{"Rep":{"Rule":84}},{"Opt":{"Rule":69}}],null]}]}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":144,"body":{"Or":[{"And":[[{"Token":14},{"Rule":90},{"Rule":83},{"Opt":{"Or":[{"And":[[{"Token":15},{"Or":[{"And":[[{"Rule":83}],null]},{"And":[[{"Rule":88}],null]}]}],null]}]}}],1]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":145,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":25},{"Rule":90},{"Rule":83}],2]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":146,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":24},{"Rule":83}],2]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":147,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":23},{"Rule":57},{"Token":32},{"Rule":91},{"Rule":83}],2]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":148,"body":{"Or":[{"And":[[{"Token":30},{"Rule":91},{"Call":[{"Rule":132},[[3,{"Rep":{"Rule":96}}]]]}],1]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":151,"body":{"Or":[{"And":[[{"Rule":128}],null]}]},"replaceable":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":152,"body":{"Or":[{"And":[[{"Rule":129}],null]}]},"replaceable":false}}}},{"Postfix":{"ty":153,"op":{"Or":[{"And":[[{"Token":58},{"Token":74},{"Opt":{"Enter":[1,{"Rule":45}]}},{"Rule":103}],null]}]}}},{"Postfix":{"ty":154,"op":{"Rule":103}}},{"Postfix":{"ty":155,"op":{"Or":[{"And":[[{"Token":58},{"Or":[{"And":[[{"Token":74}],null]},{"And":[[{"Token":75}],null]}]}],null]}]}}},{"Postfix":{"ty":156,"op":{"Call":[{"Rule":135},[[6,{"Rule":69}]]]}}},{"Prefix":{"ty":158,"op":{"Or":[{"And":[[{"Token":68},{"Opt":{"Token":27}}],null]}]},"priority":999}},{"Prefix":{"ty":159,"op":{"Token":63},"priority":999}},{"Prefix":{"ty":160,"op":{"Token":67},"priority":999}},{"Prefix":{"ty":161,"op":{"Token":71},"priority":999}},{"Binary":{"ty":162,"op":{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":63}],null]},{"And":[[{"Token":64}],null]},{"And":[[{"Token":65}],null]}]}]]]},"priority":10}},{"Binary":{"ty":163,"op":{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":66}],null]},{"And":[[{"Token":67}],null]}]}]]]},"priority":9}},{"Binary":{"ty":164,"op":{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"ContextualToken":[43,"<<"]}],null]},{"And":[[{"ContextualToken":[44,">>"]}],null]}]}]]]},"priority":8}},{"Binary":{"ty":165,"op":{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":68},{"Not":{"Token":68}}],null]}]}]]]},"priority":7}},{"Binary":{"ty":166,"op":{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":69},{"Not":{"Token":69}}],null]}]}]]]},"priority":6}},{"Binary":{"ty":167,"op":{"Call":[{"Rule":114},[[1,{"Rule":118}]]]},"priority":5}},{"Binary":{"ty":168,"op":{"Call":[{"Rule":114},[[1,{"ContextualToken":[45,"&&"]}]]]},"priority":4}},{"Binary":{"ty":169,"op":{"Call":[{"Rule":114},[[1,{"ContextualToken":[46,"||"]}]]]},"priority":3}},{"Binary":{"ty":170,"op":{"Call":[{"Rule":114},[[1,{"Rule":123}]]]},"priority":2}},{"Prefix":{"ty":170,"op":{"Rule":123},"priority":2}},{"Binary":{"ty":171,"op":{"Call":[{"Rule":114},[[1,{"Token":49}]]]},"priority":1}}]}},{"body":{"Or":[{"And":[[{"PrevIs":[140,144,145,146,147,148,151]}],null]}]}},{"body":{"Or":[{"And":[[{"Exit":[5,{"Exit":[4,{"Var":0}]}]}],null]}]}},{"body":{"Pub":{"ty_idx":130,"body":{"Or":[{"And":[[{"Token":75}],null]},{"And":[[{"Token":76}],null]},{"And":[[{"Token":77}],null]},{"And":[[{"Token":72}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":131,"body":{"Or":[{"And":[[{"Not":{"Or":[{"And":[[{"Token":74},{"Token":71}],null]}]}},{"Rule":40},{"Opt":{"Rule":74}}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":132,"body":{"Or":[{"And":[[{"Not":{"IsIn":5}},{"Call":[{"Rule":132},[[3,{"Or":[{"And":[[{"Call":[{"Rule":131},[[2,{"Rule":75}]]]},{"Opt":{"Or":[{"And":[[{"Token":59},{"Call":[{"Rule":71},[[0,{"Rule":69}]]]}],null]}]}}],null]}]}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":133,"body":{"Or":[{"And":[[{"Token":74},{"Opt":{"Or":[{"And":[[{"Token":55},{"Rule":69}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":134,"body":{"Or":[{"And":[[{"Token":35},{"Token":36}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":135,"body":{"Or":[{"And":[[{"Call":[{"Rule":133},[[4,{"Or":[{"And":[[{"Call":[{"Rule":71},[[0,{"Rule":69}]]]},{"Opt":{"Rule":78}}],null]}]}]]]}],null]}]},"replaceable":true}}},{"body":{"PubReplace":{"ty_idx":136,"body":{"Or":[{"And":[[{"Token":57},{"Call":[{"Rule":131},[[2,{"Call":[{"Rule":71},[[0,{"Rule":69}]]]}]]]}],null]}]}}}},{"body":{"Pub":{"ty_idx":137,"body":{"Or":[{"And":[[{"Call":[{"Rule":135},[[6,{"Call":[{"Rule":71},[[0,{"Call":[{"Rule":131},[[2,{"Rule":69}]]]}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":138,"body":{"Or":[{"And":[[{"Opt":{"Token":26}},{"Token":69},{"Rep":{"Rule":81}},{"Token":69},{"Or":[{"And":[[{"Token":47},{"Rule":47},{"Rule":83}],null]},{"And":[[{"Call":[{"Rule":71},[[0,{"Rule":69}]]]}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":13},{"Or":[{"And":[[{"Token":57}],null]},{"And":[[{"Not":{"Not":{"Token":69}}}],null]}]}],1]}]}},{"body":{"Pub":{"ty_idx":139,"body":{"Or":[{"And":[[{"Token":31},{"Opt":{"Rule":69}}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":140,"body":{"Or":[{"And":[[{"Call":[{"Rule":71},[[0,{"Or":[{"And":[[{"Opt":{"Token":33}},{"Call":[{"Rule":132},[[3,{"Or":[{"And":[[{"Rep":{"Rule":84}},{"Opt":{"Rule":69}}],null]}]}]]]}],null]}]}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":85}],null]},{"And":[[{"Rule":87}],null]},{"And":[[{"Rule":86}],null]},{"And":[[{"Rule":3}],null]}]}},{"body":{"Pub":{"ty_idx":141,"body":{"Or":[{"And":[[{"Token":9},{"Rule":57},{"Token":49},{"Rule":69},{"Token":54}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":142,"body":{"Or":[{"And":[[{"Token":54}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":143,"body":{"Or":[{"And":[[{"Enter":[4,{"Or":[{"And":[[{"Rule":69},{"Or":[{"And":[[{"Rule":70},{"Not":"Eof"}],null]},{"And":[[{"Token":54}],null]}]}],null]}]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":144,"body":{"Or":[{"And":[[{"Token":14},{"Rule":90},{"Rule":83},{"Opt":{"Or":[{"And":[[{"Token":15},{"Or":[{"And":[[{"Rule":83}],null]},{"And":[[{"Rule":88}],null]}]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":145,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":25},{"Rule":90},{"Rule":83}],2]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Token":9},{"Rule":57},{"Token":49}],1]}]}},{"Rule":91}],null]}]}},{"body":{"Or":[{"And":[[{"Enter":[5,{"Rule":69}]}],null]}]}},{"body":{"Pub":{"ty_idx":146,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":24},{"Rule":83}],2]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":147,"body":{"Or":[{"And":[[{"Opt":{"Rule":94}},{"Token":23},{"Rule":57},{"Token":32},{"Rule":91},{"Rule":83}],2]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Token":73},{"Token":55}],null]}]}},{"body":{"Pub":{"ty_idx":148,"body":{"Or":[{"And":[[{"Token":30},{"Rule":91},{"Call":[{"Rule":132},[[3,{"Rep":{"Rule":96}}]]]}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":149,"body":{"Or":[{"And":[[{"Rule":97},{"Token":48},{"Rule":69},{"Or":[{"And":[[{"Token":57}],null]},{"And":[["Eof"],null]},{"And":[[{"Rule":70}],null]}]}],1]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rule":57},{"Rep":{"Or":[{"And":[[{"Token":69},{"Rule":57}],null]}]}},{"Opt":{"Rule":98}}],null]}]}},{"body":{"Pub":{"ty_idx":150,"body":{"Or":[{"And":[[{"Token":14},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":151,"body":{"Or":[{"And":[[{"Rule":128}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":152,"body":{"Or":[{"And":[[{"Rule":129}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":153,"body":{"Or":[{"And":[[{"Rule":69},{"Or":[{"And":[[{"Token":58},{"Token":74},{"Opt":{"Enter":[1,{"Rule":45}]}},{"Rule":103}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":154,"body":{"Or":[{"And":[[{"Rule":69},{"Rule":103}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":71},[[0,{"Call":[{"Rule":133},[[4,{"Call":[{"Rule":131},[[2,{"Rule":106}]]]}]]]}]]]}],null]}]}},{"body":{"Pub":{"ty_idx":155,"body":{"Or":[{"And":[[{"Rule":69},{"Or":[{"And":[[{"Token":58},{"Or":[{"And":[[{"Token":74}],null]},{"And":[[{"Token":75}],null]}]}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":156,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":135},[[6,{"Rule":69}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":157,"body":{"Or":[{"And":[[{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":158,"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":68},{"Opt":{"Token":27}}],null]}]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":159,"body":{"Or":[{"And":[[{"Token":63},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":160,"body":{"Or":[{"And":[[{"Token":67},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":161,"body":{"Or":[{"And":[[{"Token":71},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":162,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":63}],null]},{"And":[[{"Token":64}],null]},{"And":[[{"Token":65}],null]}]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":163,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":66}],null]},{"And":[[{"Token":67}],null]}]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":164,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"ContextualToken":[43,"<<"]}],null]},{"And":[[{"ContextualToken":[44,">>"]}],null]}]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"IsIn":4},{"Not":{"Rule":70}},{"Var":1}],null]},{"And":[[{"Not":{"IsIn":4}},{"Var":1}],null]}]}},{"body":{"Pub":{"ty_idx":165,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":68},{"Not":{"Token":68}}],null]}]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":166,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Or":[{"And":[[{"Token":69},{"Not":{"Token":69}}],null]}]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":167,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Rule":118}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Token":50}],null]},{"And":[[{"Token":51}],null]},{"And":[[{"Token":39}],null]},{"And":[[{"Token":40}],null]},{"And":[[{"Token":53}],null]},{"And":[[{"Token":52}],null]}]}},{"body":{"Pub":{"ty_idx":168,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"ContextualToken":[45,"&&"]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":169,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"ContextualToken":[46,"||"]}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":170,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Rule":123}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":170,"body":{"Or":[{"And":[[{"Rule":123},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Or":[{"And":[[{"Token":59}],null]},{"And":[[{"Token":60}],null]}]},{"Not":{"Or":[{"And":[[{"Token":37},{"IsIn":5}],null]}]}}],null]}]}},{"body":{"Pub":{"ty_idx":171,"body":{"Or":[{"And":[[{"Rule":69},{"Call":[{"Rule":114},[[1,{"Token":49}]]]},{"Rule":69}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":172,"body":{"Or":[{"And":[[{"Token":61},{"Call":[{"Rule":135},[[6,{"Call":[{"Rule":131},[[2,{"Rule":127}]]]}]]]}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"Rule":125}}],null]}]}},{"body":{"Pub":{"ty_idx":173,"body":{"Or":[{"And":[[{"Token":74},{"Opt":{"Or":[{"And":[[{"Token":49},{"Rule":69}],null]},{"And":[[{"Call":[{"Rule":133},[[4,{"Call":[{"Rule":131},[[2,{"Rule":127}]]]}]]]}],null]}]}}],1]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":174,"body":{"Or":[{"And":[[{"Token":74},{"Token":71},{"Opt":{"Token":74}},{"Call":[{"Rule":132},[[3,{"Rep":{"Rule":130}}]]]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":175,"body":{"Or":[{"And":[[{"Token":74},{"Token":71},{"Opt":{"Token":74}},{"Or":[{"And":[[{"Token":35},{"Rep":{"Rule":130}},{"Token":36}],null]},{"And":[[{"Token":41},{"Rep":{"Rule":130}},{"Token":42}],null]}]}],null]}]},"replaceable":false}}},{"body":{"Pub":{"ty_idx":176,"body":{"Or":[{"And":[[{"Not":{"Or":[{"And":[[{"Token":35}],null]},{"And":[[{"Token":36}],null]},{"And":[[{"Token":37}],null]},{"And":[[{"Token":38}],null]},{"And":[[{"Token":41}],null]},{"And":[[{"Token":42}],null]}]}},"Any"],null]},{"And":[[{"Token":35},{"Rep":{"Rule":130}},{"Token":36}],null]},{"And":[[{"Token":41},{"Rep":{"Rule":130}},{"Token":42}],null]},{"And":[[{"Token":37},{"Rep":{"Rule":130}},{"Token":38}],null]}]},"replaceable":false}}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":2},{"Or":[{"And":[["Eof"],null]},{"And":[[{"Token":57}],null]}]}],1]}]}}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":136},[[7,{"Token":37}],[8,{"Token":38}],[9,{"Var":3}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":136},[[7,{"Token":35}],[8,{"Token":36}],[9,{"Var":4}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":136},[[7,{"Token":39}],[8,{"Token":40}],[9,{"Var":5}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Call":[{"Rule":136},[[7,{"Token":41}],[8,{"Token":42}],[9,{"Var":6}]]]}],null]}]}},{"body":{"Or":[{"And":[[{"Var":7},{"Layer":[{"Call":[{"Rule":137},[[10,{"Var":7}],[11,{"Var":8}]]]},{"Var":9}]},{"Var":8}],1]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Or":[{"And":[[{"Var":10},{"Call":[{"Rule":137},[[10,{"Var":10}],[11,{"Var":11}]]]},{"Var":11}],1]},{"And":[[{"Or":[{"And":[[{"Not":{"Var":11}},"Any"],null]}]}],null]}]}}],null]}]}}]"##;

    ::fall_parse::ParserDefinition {
        node_types: vec![
            ERROR,
            WHITESPACE, LINE_COMMENT, BLOCK_COMMENT, UNION, AS, CRATE, EXTERN, FN, LET, PUB, STRUCT, USE, MOD, IF, ELSE, ENUM, IMPL, SELF, SUPER, TYPE, CONST, STATIC, FOR, LOOP, WHILE, MOVE, MUT, REF, TRAIT, MATCH, RETURN, IN, UNSAFE, WHERE, L_PAREN, R_PAREN, L_CURLY, R_CURLY, L_ANGLE, R_ANGLE, L_BRACK, R_BRACK, SHL, SHR, AND, OR, THIN_ARROW, FAT_ARROW, EQ, EQEQ, BANGEQ, GTET, LTEQ, SEMI, COLON, COLONCOLON, COMMA, DOT, DOTDOT, DOTDOTDOT, HASH, DOLLAR, STAR, SLASH, PERCENT, PLUS, MINUS, AMPERSAND, PIPE, UNDERSCORE, BANG, CHAR, LIFETIME, IDENT, NUMBER, STRING, RAW_STRING, FILE, USE_DECL, USE_SPEC, USE_SPEC_ENTRY, EXTERN_CRATE_DECL, FN_DEF, LINKAGE, VALUE_PARAM, LAMBDA_VALUE_PARAM, SELF_PARAMETER, STRUCT_DEF, STRUCT_FIELD, TUPLE_FIELD, ENUM_DEF, ENUM_VARIANT, MOD_DEF, IMPL_DEF, TRAIT_DEF, MEMBERS, TYPE_DEF, CONST_DEF, MACRO_ITEM, EXTERN_BLOCK, TYPE_PARAMETERS, TYPE_PARAMETER, TYPE_BOUND, LIFETIME_PARAMETER, VISIBILITY, WHERE_CLAUSE, PATH, TYPE_ARGUMENTS, ALIAS, PATH_TYPE, REFERENCE_TYPE, PLACEHOLDER_TYPE, UNIT_TYPE, PAREN_TYPE, TUPLE_TYPE, ARRAY_TYPE, FN_POINTER_TYPE, WILDCARD_PATTERN, PATH_PATTERN, TUPE_STRUCT_PATTERN, STRUCT_PATTERN, STRUCT_PATTERN_FIELD, BINDING_PATTERN, LITERAL_PATTERN, UNIT_PATTERN, PAREN_PATTERN, TUPLE_PATTERN, REFERENCE_PATTERN, EXPR, LITERAL, PATH_EXPR, STRUCT_LITERAL, STRUCT_LITERAL_FIELD, UNIT_EXPR, PAREN_EXPR, TUPLE_EXPR, ARRAY_LITERAL, LAMBDA_EXPR, RETURN_EXPR, BLOCK_EXPR, LET_STMT, EMPTY_STMT, EXPR_STMT, IF_EXPR, WHILE_EXPR, LOOP_EXPR, FOR_EXPR, MATCH_EXPR, MATCH_ARM, GUARD, BLOCK_MACRO_EXPR, LINE_MACRO_EXPR, METHOD_CALL_EXPR, CALL_EXPR, FIELD_EXPR, INDEX_EXPR, VALUE_ARGUMENT, REFERENCE_EXPR, DEREFERENCE_EXPR, NEGATION_EXPR, NOT_EXPR, PRODUCT_EXPR, SUM_EXPR, BIT_SHIFT, BIT_AND, BIT_OR, COMPARISON, LOGICAL_AND, LOGICAL_OR, RANGE_EXPR, ASSIGNMENT_EXPR, ATTRIBUTE, ATTR_VALUE, BLOCK_MACRO, LINE_MACRO, TT,
        ],
        lexical_rules: vec![
