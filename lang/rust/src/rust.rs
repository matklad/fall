...
fn create_parser_definition() -> ::fall_parse::ParserDefinition {
    ...
    ::fall_parse::ParserDefinition {
        ...
        lexical_rules: vec![
            ...
            LexRule::new(STAR_EQ, "\\*=", None),
            LexRule::new(SLASH, "/", None),
            LexRule::new(SLASH_EQ, "/=", None),
            LexRule::new(PERCENT, "%", None),
            LexRule::new(PERCENT_EQ, "%=", None),
            LexRule::new(PLUS, "\\+", None),
            LexRule::new(PLUS_EQ, "\\+=", None),
            LexRule::new(MINUS, "\\-", None),
            LexRule::new(MINUS_EQ, "\\-=", None),
            LexRule::new(AMPERSAND, "\\&", None),
            LexRule::new(AMPERSAND_EQ, "\\&=", None),
            LexRule::new(PIPE, "\\|", None),
            LexRule::new(PIPE_EQ, "\\|=", None),
            LexRule::new(UNDERSCORE, "_", None),
            LexRule::new(BANG, "!", None),
            LexRule::new(QUESTION, "\\?", None),
            LexRule::new(CARET, "\\^", None),
            LexRule::new(CARET_EQ, "\\^=", None),
