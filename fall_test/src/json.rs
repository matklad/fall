...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"ty":12,"body":{"Or":[{"And":[[{"Rule":1}],null]},{"And":[[{"Rule":4}],null]}]}},{"ty":13,"body":{"Or":[{"And":[[{"Token":2},{"Rule":2},{"Token":3}],1]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Rep":[{"Or":[{"And":[[{"Rule":3},{"Opt":{"Token":7}}],1]}]},[10],[3]]}],null]}]}},{"ty":14,"body":{"Or":[{"And":[[{"Token":10},{"Token":6},{"Rule":5}],1]}]}},{"ty":15,"body":{"Or":[{"And":[[{"Token":4},{"Rep":[{"Or":[{"And":[[{"Rule":5},{"Opt":{"Token":7}}],null]}]},[8,11,10,9,2,4],[5]]},{"Token":5}],1]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Rule":6}],null]},{"And":[[{"Rule":1}],null]},{"And":[[{"Rule":4}],null]}]}},{"ty":16,"body":{"Or":[{"And":[[{"Token":8}],null]},{"And":[[{"Token":11}],null]},{"And":[[{"Token":10}],null]},{"And":[[{"Token":9}],null]}]}}]"##;
