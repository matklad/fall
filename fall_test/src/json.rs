...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"ty":16,"body":{"Or":[{"And":[[{"Rule":1}],null]},{"And":[[{"Rule":4}],null]}]}},{"ty":12,"body":{"Or":[{"And":[[{"Token":6},{"Rule":2},{"Token":7}],1]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Rep":[{"Or":[{"And":[[{"Rule":3},{"Token":10}],null]}]},[5],[7]]}],null]}]}},{"ty":15,"body":{"Or":[{"And":[[{"Token":5},{"Token":11},{"Rule":5}],1]}]}},{"ty":13,"body":{"Or":[{"And":[[{"Token":8},{"Rep":[{"Or":[{"And":[[{"Rule":5},{"Token":10}],null]}]},[2,4,5,3,6,8],[9]]},{"Token":9}],1]}]}},{"ty":null,"body":{"Or":[{"And":[[{"Rule":6}],null]},{"And":[[{"Rule":1}],null]},{"And":[[{"Rule":4}],null]}]}},{"ty":14,"body":{"Or":[{"And":[[{"Token":2}],null]},{"And":[[{"Token":4}],null]},{"And":[[{"Token":5}],null]},{"And":[[{"Token":3}],null]}]}}]"##;
