...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"body":{"Pub":[12,{"Or":[{"And":[[{"Token":5},{"Token":2}],null]},{"And":[[{"Token":6},{"Rule":4},{"Token":11},{"Rule":4}],null]},{"And":[[{"Token":7},{"Rule":1}],null]},{"And":[[{"Token":8},{"Rule":6}],null]}]}]}},{"body":{"Pub":[13,{"Or":[{"And":[[{"Rule":2}],null]},{"And":[[{"Rule":3}],null]}]}]}},{"body":{"Or":[{"And":[[{"Token":3},{"Token":4}],null]}]}},{"body":{"Or":[{"And":[[{"Token":3},{"Token":3}],null]}]}},{"body":{"Pub":[14,{"Or":[{"And":[[{"Opt":{"Or":[{"And":[[{"Rule":5}],null]}]}}],null]}]}]}},{"body":{"Or":[{"And":[[],null]}]}},{"body":{"Pub":[15,{"Or":[{"And":[[{"Token":9},{"Rule":7},{"Token":10}],1]}]}]}},{"body":{"Or":[{"And":[[{"Rep":{"Rule":8}}],null]}]}},{"body":{"Or":[{"And":[[{"Token":9},{"Rule":7},{"Token":10}],1]},{"And":[[{"Not":{"Token":10}}],null]}]}}]"##;
