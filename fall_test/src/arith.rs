...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"body":{"Pub":[9,{"Or":[{"And":[[{"Rule":1}],null]}]}]}},{"body":{"Pratt":[{"Binary":{"ty":11,"op":{"Or":[{"And":[[{"Token":3}],null]},{"And":[[{"Token":4}],null]}]},"priority":1}},{"Binary":{"ty":10,"op":{"Or":[{"And":[[{"Token":5}],null]},{"And":[[{"Token":6}],null]}]},"priority":2}},{"Atom":{"ty":12,"body":{"Or":[{"And":[[{"Token":2}],null]}]}}},{"Atom":{"ty":13,"body":{"Or":[{"And":[[{"Token":7},{"Rule":1},{"Token":8}],null]}]}}}]}},{"body":{"Pub":[10,{"Or":[{"And":[[{"Rule":1},{"Or":[{"And":[[{"Token":5}],null]},{"And":[[{"Token":6}],null]}]},{"Rule":1}],null]}]}]}},{"body":{"Pub":[11,{"Or":[{"And":[[{"Rule":1},{"Or":[{"And":[[{"Token":3}],null]},{"And":[[{"Token":4}],null]}]},{"Rule":1}],null]}]}]}}]"##;
