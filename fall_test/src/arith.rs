...
lazy_static! {
    pub static ref LANG: Language = {
        ...
        let parser_json = r##"[{"body":{"Pub":{"ty_idx":10,"body":{"Or":[{"And":[[{"Rule":1}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pratt":[{"Binary":{"ty":12,"op":{"Or":[{"And":[[{"Token":3}],null]},{"And":[[{"Token":4}],null]}]},"priority":1}},{"Binary":{"ty":11,"op":{"Or":[{"And":[[{"Token":5}],null]},{"And":[[{"Token":6}],null]}]},"priority":2}},{"Postfix":{"ty":15,"op":{"Token":7}}},{"Prefix":{"ty":16,"op":{"Token":4}}},{"Atom":{"body":{"Pub":{"ty_idx":13,"body":{"Or":[{"And":[[{"Token":2}],null]}]},"replaceable":false,"replaces":false}}}},{"Atom":{"body":{"Pub":{"ty_idx":14,"body":{"Or":[{"And":[[{"Token":8},{"Rule":1},{"Token":9}],null]}]},"replaceable":false,"replaces":false}}}}]}},{"body":{"Pub":{"ty_idx":11,"body":{"Or":[{"And":[[{"Rule":1},{"Or":[{"And":[[{"Token":5}],null]},{"And":[[{"Token":6}],null]}]},{"Rule":1}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pub":{"ty_idx":12,"body":{"Or":[{"And":[[{"Rule":1},{"Or":[{"And":[[{"Token":3}],null]},{"And":[[{"Token":4}],null]}]},{"Rule":1}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pub":{"ty_idx":13,"body":{"Or":[{"And":[[{"Token":2}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pub":{"ty_idx":14,"body":{"Or":[{"And":[[{"Token":8},{"Rule":1},{"Token":9}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pub":{"ty_idx":15,"body":{"Or":[{"And":[[{"Rule":1},{"Token":7}],null]}]},"replaceable":false,"replaces":false}}},{"body":{"Pub":{"ty_idx":16,"body":{"Or":[{"And":[[{"Token":4},{"Rule":1}],null]}]},"replaceable":false,"replaces":false}}}]"##;
