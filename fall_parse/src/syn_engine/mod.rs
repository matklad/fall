...
use fall_tree::{NodeType, INode, Language};
...
impl BlackNode {
    pub fn into_white_node(self, lang: &Language, tokens: &[Token]) -> WhiteNode {
        black_to_white(lang, self, tokens, (0, tokens.len()), true)
    }
}
